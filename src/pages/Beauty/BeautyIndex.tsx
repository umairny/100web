      ...
      <section className="relative overflow-hidden bg-[#fff0f6] py-16 md:py-24">
        ...
        <Container>
          <AnimatedSection className="relative max-w-4xl">
            <Link to="/" className="text-sm font-bold text-pink-700 transition hover:text-pink-900">
              Back to Home
            </Link>
            <div className="mt-8 inline-flex rounded-full bg-pink-100 px-4 py-2 text-sm font-black text-pink-800 scale-in">
      ...
      <section className="py-20 md:py-28">
        <Container>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {beautyWebsites.map((website, index) => (
