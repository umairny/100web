...
const galleryItems = [
  {
    title: "Barber chairs",
    image: barberImages.chairs,
    alt: "Classic Crown and Comb barber chairs in the shop",
  },
  {
    title: "Precision haircut",
    image: barberImages.haircut,
    alt: "Precision haircut service at Crown and Comb Barber",
  },
  {
    title: "Grooming tools",
    image: barberImages.tools,
    alt: "Premium barber grooming tools laid out for service",
  },
  {
    title: "Studio interior",
    image: barberImages.interior,
    alt: "Warm Crown and Comb Barber studio interior",
  },
  {
    title: "Beard trim",
    image: barberImages.beardTrim,
    alt: "Detailed beard trim and line up service",
  },
  {
    title: "Premium products",
    image: barberImages.products,
    alt: "Premium grooming products for barber clients",
  },
];
...
const shopItems = [
  {
    title: "Texture Clay",
    image: barberImages.products,
    alt: "Premium texture clay and grooming products",
  },
  {
    title: "Beard Oil",
    image: barberImages.beardTrim,
    alt: "Beard care product used for clean grooming finishes",
  },
  {
    title: "Pocket Comb",
    image: barberImages.tools,
    alt: "Barber comb and grooming tools",
  },
];
    ...
    <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
      ...
      {name === "bell" && (
        <>
          <path
            {...strokeProps}
            d="M18 9a6 6 0 0 0-12 0c0 7-2 7-2 9h16c0-2-2-2-2-9"
          />
      ...
      {name === "quality" && (
        <>
          <path
            {...strokeProps}
            d="M12 3l2.4 2.1 3.2-.1.8 3.1 2.6 1.9-1.3 2.9.8 3.1-3 1.1-1.8 2.7-3-1.1-3 1.1-1.8-2.7-3-1.1.8-3.1-1.3-2.9 2.6-1.9.8-3.1 3.2.1z"
          />
...
function BrandMark({ compact = false }: { compact?: boolean }) {
  return (
    <Link to="/beauty/crown-comb-barber" className="flex items-center gap-3">
      ...
      <span>
        <span
          className={`${compact ? "text-sm" : "text-xl"} block font-serif font-black leading-none tracking-wide text-white`}
        >
          Crown & Comb
        </span>
        <span className="block text-[0.62rem] font-black uppercase tracking-[0.32em] text-[#c8934b]">
          Barber
        </span>
      </span>
    </Link>
      ...
      <Container>
        <div className="hidden h-20 items-center justify-between gap-8 lg:flex">
          ...
          <nav
            ...
            className="flex items-center gap-7 text-[0.72rem] font-black uppercase tracking-[0.08em] text-white"
          >
            {navLinks.map((item) => {
              ...
              return (
                <a
                  ...
                  className={`relative py-3 transition hover:text-[#c8934b] focus:outline-none focus-visible:text-[#c8934b] ${
                    isActive
                      ? "active text-[#c8934b] after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-[#c8934b]"
                      : "text-white/82"
                  }`}
                >
                  {item}
          ...
          <a
            ...
            onClick={(event) => {
              event.preventDefault();
              navigateToSection("#book-online");
            }}
            className={`rounded-md px-7 py-3 text-sm font-black uppercase tracking-[0.08em] text-white shadow-lg shadow-black/25 transition hover:-translate-y-0.5 hover:bg-[#dfad67] ${activeSection === "book-online" ? "active bg-[#dfad67]" : "bg-[#c8934b]"}`}
          >
            Book Appointment
          </a>
        </div>
        ...
        <div className="flex h-20 items-center justify-between lg:hidden">
          ...
          <button
            ...
            className="grid h-11 w-11 place-items-center rounded-xl border border-[#3c3021] text-white"
          >
            <Icon name="bell" />
          </button>
        </div>
    ...
    >
      ...
      <Container className="relative grid min-h-[650px] items-center py-20 lg:min-h-[720px] lg:grid-cols-[0.92fr_1.08fr]">
        <div className="max-w-2xl">
          <p className="text-sm font-black uppercase tracking-[0.26em] text-[#c8934b]">
            Classic tradition. Modern precision.
          </p>
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <a
              href="#book-online"
              className="inline-flex min-h-12 items-center justify-center rounded-md bg-[#c8934b] px-7 text-sm font-black uppercase tracking-[0.08em] text-white shadow-xl shadow-black/25 transition hover:-translate-y-0.5 hover:bg-[#dfad67]"
            >
              Book Appointment
            </a>
            <a
              href="#services"
              className="inline-flex min-h-12 items-center justify-center rounded-md border border-[#8c7251] bg-black/18 px-7 text-sm font-black uppercase tracking-[0.08em] text-white transition hover:-translate-y-0.5 hover:bg-white/10"
            >
              View Services
            </a>
          </div>
...
function ServiceCard({ service }: { service: Service }) {
  return (
    <article className="group rounded-lg border border-[#372c1e] bg-[linear-gradient(145deg,#1a1a16,#10110e)] p-8 text-center shadow-xl shadow-black/20 transition duration-300 hover:-translate-y-1 hover:border-[#c8934b]">
      ...
      <h3 className="mt-5 font-serif text-xl font-black text-white">
        {service.title}
      </h3>
      <p className="mx-auto mt-3 max-w-48 text-sm leading-6 text-[#d5cbbb]">
        {service.description}
      </p>
      <a
        href="#book-online"
        className="mt-5 inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.14em] text-[#c8934b] transition hover:text-white"
      >
...
function ServicesSection() {
  return (
    <section
      id="services"
      className="scroll-mt-20 border-y border-[#211b13] bg-[#0d0f0c] py-20 md:py-24"
    >
      <Container>
        <p className="text-center text-sm font-black uppercase tracking-[0.24em] text-[#c8934b]">
          Our services
        </p>
...
function BookingForm({ mobile = false }: { mobile?: boolean }) {
  ...
  return (
    <form
      className={
        mobile
          ? "rounded-2xl border border-[#314424] bg-[#172413] p-4 shadow-xl shadow-black/30"
          : "grid gap-4 lg:grid-cols-[repeat(4,minmax(0,1fr))_auto] lg:items-stretch"
      }
      onSubmit={(event) => event.preventDefault()}
    >
      {mobile && (
        <h3 className="mb-4 text-sm font-black uppercase tracking-[0.12em] text-white">
        ...
        {fields.map(([label, value]) => (
          <label key={label} className={inputClass}>
            <span
              className={
                mobile
                  ...
                  : "block text-[0.66rem] font-black uppercase tracking-[0.12em] text-[#887a68]"
              }
            >
              {label}
            </span>
            <select
              className={
                mobile
                  ? "min-w-0 appearance-none bg-transparent text-sm font-medium text-[#e9dcc9] outline-none"
                  : "mt-2 w-full bg-transparent text-sm font-bold text-[#17130e] outline-none"
              }
            >
              <option>{value}</option>
            </select>
      ...
      <button
        ...
        className={
          mobile
            ? "mt-4 min-h-12 w-full rounded-lg bg-[#c8934b] text-sm font-black uppercase tracking-[0.08em] text-white shadow-lg shadow-black/25 transition hover:bg-[#dfad67]"
            : "rounded-lg bg-[#172716] px-10 py-4 text-sm font-black uppercase tracking-[0.08em] text-white shadow-lg shadow-black/10 transition hover:-translate-y-0.5 hover:bg-[#c8934b]"
        }
      >
        Book Now
      </button>
...
function AppointmentSection() {
  return (
    <section id="book-online" className="scroll-mt-20">
      <div className="hidden bg-[#f6efe5] py-10 text-[#17130e] lg:block">
        <Container className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.18em] text-[#8c642e]">
              Book your appointment
            </p>
            ...
            <div className="mt-5 flex flex-wrap gap-5 text-sm font-bold text-[#695b49]">
              {["Expert Barbers", "Premium Products", "Great Experience"].map(
                (item) => (
...
function AboutSection() {
  return (
    <section id="about" className="scroll-mt-20 bg-[#090a08] py-20 md:py-24">
      <Container className="grid gap-10 lg:grid-cols-[0.95fr_0.75fr_0.7fr] lg:items-center">
        <div className="min-h-[21rem] overflow-hidden rounded-lg border border-[#332819] bg-[#14140f] shadow-2xl shadow-black/25">
          <img
            ...
            alt="Crown & Comb Barber interior"
            className="h-full w-full object-cover"
          />
        </div>
        <div>
          <p className="text-sm font-black uppercase tracking-[0.24em] text-[#c8934b]">
            Our story
          </p>
          ...
          <p className="mt-5 text-base leading-8 text-[#d5cbbb]">
            Crown & Comb Barber was built around precision grooming, calm
            service, and confident style. We combine timeless technique with
            modern appointment flow so every visit feels sharp and easy.
          </p>
          <a
            href="#contact"
            className="mt-7 inline-flex rounded-md border border-[#8c7251] px-7 py-3 text-xs font-black uppercase tracking-[0.12em] text-white transition hover:bg-white/10"
          >
            Learn More About Us
          </a>
        </div>
        <div className="rounded-lg border border-[#3e4a2d] bg-[#162415] p-6 shadow-xl shadow-black/20">
          {features.map((feature) => (
            <article
              key={feature.title}
              className="grid grid-cols-[3.25rem_1fr] gap-4 border-b border-white/10 py-5 first:pt-0 last:border-b-0 last:pb-0"
            >
              ...
              <span>
                ...
                <span className="mt-1 block text-sm text-[#d5cbbb]">
                  {feature.text}
                </span>
              </span>
            </article>
      ...
      <Container>
        <div className="mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          ...
          <p className="max-w-xl text-sm leading-6 text-[#d5cbbb]">
            A closer look at the chairs, tools, details, and finishing touches
            that shape the Crown & Comb experience.
          </p>
        </div>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {galleryItems.map((item, index) => (
            <article
              key={item.title}
              className="group overflow-hidden rounded-lg border border-[#332819] bg-[#14140f] shadow-xl shadow-black/20"
            >
              <div className="relative aspect-[4/3]">
                <img
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-[linear-gradient(180deg,transparent_40%,rgba(7,8,7,0.78))]" />
                <div className="absolute bottom-4 left-4 rounded-full border border-white/15 bg-black/45 px-4 py-2 text-xs font-black uppercase tracking-[0.12em] text-white backdrop-blur">
      ...
      <Container className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 text-lg leading-8 text-[#695b49]">
            Pomades, oils, combs, and aftercare products curated by the barbers
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {shopItems.map((item) => (
            <article
              key={item.title}
              className="overflow-hidden rounded-lg border border-[#d9cbb7] bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
            >
              <div className="aspect-square overflow-hidden bg-[#1b1712]">
                <img
                  src={item.image}
                  alt={item.alt}
...
function Footer() {
  return (
    <footer
      id="contact"
      className="scroll-mt-20 bg-[#070807] pb-24 pt-16 text-[#d5cbbb] lg:pb-10"
    >
      <Container className="grid gap-10 lg:grid-cols-[1.1fr_0.8fr_0.8fr_1fr]">
        <div>
          <BrandMark />
          <p className="mt-5 max-w-sm text-sm leading-7">
            Premium grooming, precision cuts, and a timeless shop experience for
            clients who care about the details.
          </p>
        </div>
        <div>
          <h3 className="font-black uppercase tracking-[0.14em] text-white">
            Address
          </h3>
          ...
          <div className="mt-4 flex gap-3 text-[#c8934b]">
            {["IG", "FB", "YT"].map((item) => (
              <a
                key={item}
                href="#home"
                className="grid h-9 w-9 place-items-center rounded-full border border-[#3c3021] text-xs font-black transition hover:bg-[#c8934b] hover:text-[#070807]"
              >
                {item}
              </a>
            ))}
        ...
        <form
          className="rounded-lg border border-[#332819] bg-[#10110e] p-5"
          onSubmit={(event) => event.preventDefault()}
        >
          <h3 className="font-black uppercase tracking-[0.14em] text-white">
            Email signup
          ...
          <p className="mt-3 text-sm leading-6">
            Get grooming notes and appointment reminders.
          </p>
          <label className="mt-5 flex min-h-12 overflow-hidden rounded-md border border-[#3c3021] bg-black/20">
            ...
            <input
              ...
              className="min-w-0 flex-1 bg-transparent px-4 text-sm text-white outline-none placeholder:text-white/42"
            />
            <button
              type="submit"
              aria-label="Subscribe"
              className="grid w-12 place-items-center bg-[#c8934b] text-[#070807]"
            >
              <Icon name="mail" />
            </button>
          </label>
...
function MobileBottomNav() {
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-50 grid grid-cols-4 border-t border-white/10 bg-[#080907]/96 px-3 pb-4 pt-3 backdrop-blur lg:hidden"
    >
      {bottomNav.map(([icon, label], index) => (
        <a
          ...
          className={`flex flex-col items-center gap-1 text-[0.68rem] font-medium ${index === 0 ? "text-[#c8934b]" : "text-white/72"}`}
        >
