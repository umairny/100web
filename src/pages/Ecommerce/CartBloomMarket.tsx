...
const products = [
  [
    "Daily Desk Kit",
    "$68",
    "Notebook, pen tray, cable clips, and focus timer for cleaner workdays.",
  ],
  [
    "Weekend Reset Box",
    "$84",
    "Tea, candle, soft planner, and small home rituals in one gift-ready bundle.",
  ],
  [
    "Travel Pouch Set",
    "$42",
    "Three color-coded pouches for tech, toiletries, and everyday carry.",
  ],
];
...
const bundles = [
  ...
  [
    "Gift Box",
    "Ships wrapped",
    "Curated picks with a handwritten note option.",
  ],
  [
    "Subscribe and Save",
    "Save 18%",
    "Seasonal boxes delivered every two months.",
  ],
];
...
const reviews = [
  [
    "Avery Stone",
    "Everything felt thoughtfully selected, not random. Checkout was fast and the gift note was perfect.",
  ],
  [
    "Mina Patel",
    "The product cards made it easy to compare bundles. I found what I needed in two minutes.",
  ],
  [
    "Jordan Lee",
    "Beautiful packaging, clear shipping, and the subscription option was impossible to miss.",
  ],
];
      ...
      <section className="relative overflow-hidden bg-[#2e1065] pb-20 pt-32 text-white md:pb-28 md:pt-40">
        ...
        <Container>
          <div className="relative grid gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.26em] text-[#fbcfe8]">
                CartBloom Market
              </p>
              <h1 className="mt-5 max-w-5xl text-5xl font-black leading-[0.92] md:text-7xl">
                Curated essentials that make gifting and everyday shopping
                easier.
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/74">
                A polished online store concept with fast product discovery,
                bundle offers, shipping confidence, review proof, and checkout
                CTAs that stay close to the shopping flow.
              </p>
                  ...
                  <div className="relative bg-[linear-gradient(135deg,#f3e8ff,#7c3aed_52%,#ec4899)]">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-white/94 p-5 shadow-xl">
                      ...
                      <h2 className="mt-2 text-3xl font-black">
                        The Weekend Reset Box
                      </h2>
                      <p className="mt-2 text-sm font-bold text-slate-500">
                        Ships wrapped / 4.8 rating / gift note included
                      </p>
                    </div>
                  </div>
        ...
        <Container>
          <div className="mb-12 grid gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-black leading-tight md:text-5xl">
                Product cards made for fast comparison.
              </h2>
            </div>
            <p className="max-w-2xl text-lg leading-8 text-slate-600">
              E-commerce homepages need shoppers to understand product type,
              price, value, and next action without opening every detail page.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {products.map(([name, price, detail]) => (
              <article
                key={name}
                className="overflow-hidden bg-white shadow-xl shadow-slate-950/8"
              >
                <div className="h-56 bg-[linear-gradient(135deg,#f3e8ff,#7c3aed_52%,#ec4899)]" />
                <div className="p-6">
                  <div className="flex items-start justify-between gap-4">
                    <h3 className="text-2xl font-black">{name}</h3>
                    <span className="rounded-full bg-[#f3e8ff] px-3 py-1 text-sm font-black text-[#7c3aed]">
                      {price}
                    </span>
                  </div>
                  ...
                  <a
                    href="#checkout"
                    className="mt-6 inline-flex w-full justify-center rounded-lg bg-[#17111f] px-4 py-3 text-sm font-bold text-white transition hover:bg-[#7c3aed]"
                  >
                    Add to Cart
                  </a>
                </div>
        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-black leading-tight md:text-5xl">
                Clear offer framing keeps shoppers from drifting away.
              </h2>
              <p className="mt-5 text-lg leading-8 text-slate-600">
                Bundle cards make savings, gifting, and subscription value
                visible without crowding the product grid.
              </p>
            </div>
            <div className="grid gap-5 md:grid-cols-3">
              {bundles.map(([title, badge, text]) => (
                <article key={title} className="bg-[#fbf7ff] p-6 shadow-sm">
                  <p className="text-sm font-black uppercase tracking-[0.16em] text-[#ec4899]">
                    {badge}
                  </p>
      ...
      <section id="reviews" className="py-20 md:py-28">
        <Container>
          <div className="mb-12 max-w-3xl">
            ...
            <h2 className="mt-3 text-4xl font-black leading-tight md:text-5xl">
              Reviews that answer buying hesitation.
            </h2>
          </div>
          <div className="grid gap-5 md:grid-cols-3">
            {reviews.map(([name, quote]) => (
              <blockquote key={name} className="bg-white p-7 shadow-sm">
                ...
                <footer className="mt-6 text-sm font-black uppercase tracking-[0.18em] text-[#7c3aed]">
                  {name}
                </footer>
              </blockquote>
            ))}
      ...
      <section id="checkout" className="bg-[#2e1065] py-20 text-white md:py-28">
        <Container>
          <div className="grid gap-8 lg:grid-cols-[1fr_0.76fr] lg:items-center">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.24em] text-[#fbcfe8]">
                Checkout flow
              </p>
              <h2 className="mt-4 max-w-3xl text-4xl font-black leading-tight md:text-5xl">
                Keep the offer, cart, shipping, and support promises close
                together.
              </h2>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-white/70">
                A store homepage should remove doubt before checkout: shipping
                thresholds, returns, reviews, and bundle savings all stay
                visible.
              </p>
            </div>
            <div className="bg-white p-6 text-[#17111f]">
              ...
              <a
                href="mailto:orders@cartbloom.example"
                className="mt-6 block bg-[#7c3aed] px-5 py-4 text-center text-sm font-black text-white transition hover:bg-[#5b21b6]"
              >
                Continue Checkout
              </a>
            </div>
