...
const uxNotes = [
  [
    "Merchandise fast",
    "E-commerce pages need product hierarchy, clear offers, trust cues, and a cart path that stays obvious.",
  ],
  [
    "Reduce buying friction",
    "Visitors should understand shipping, returns, reviews, and product value before comparing alternatives.",
  ],
  [
    "Design for scanning",
    "Strong category blocks, quick product cards, and offer rhythm help shoppers move without getting tired.",
  ],
];
...
export function EcommerceIndex() {
  const liveWebsites = ecommerceWebsites.filter(
  ...
  return (
    <main className="bg-[#fbf7ff] text-[#17111f]">
          ...
          <AnimatedSection className="relative grid gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
            <div>
              ...
              <h1 className="mt-6 max-w-5xl text-5xl font-black leading-[0.92] md:text-7xl">
                E-commerce websites built for discovery, trust, and checkout
                momentum.
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/74">
                A category hub for online stores, product launches, curated
                shops, subscription boxes, and retail brands that need polished
                browsing and fewer buying doubts.
              </p>
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <CTAButton
                  href="#live-concepts"
                  size="lg"
                  className="bg-[#fbcfe8] text-[#2e1065] hover:bg-white"
                >
                  View Live Concept
                </CTAButton>
                <CTAButton
                  ...
                  <div className="relative bg-[linear-gradient(135deg,#f3e8ff,#7c3aed_54%,#ec4899)]">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-white/94 p-5 shadow-xl">
                      ...
                      <p className="mt-2 text-3xl font-black">
                        Curated products with a checkout path that stays close.
                      </p>
                    </div>
                  </div>
        ...
        <Container>
          <div className="flex flex-wrap justify-center gap-2">
            {shopTypes.map((item) => (
              <span
                key={item}
                className="rounded-full border border-[#eadcff] bg-[#fbf7ff] px-4 py-2 text-sm font-bold text-slate-600"
              >
                {item}
              </span>
            ))}
        ...
        <Container>
          <AnimatedSection className="mb-12 grid gap-6 lg:grid-cols-[0.86fr_1.14fr] lg:items-end">
            ...
            <p className="max-w-2xl text-lg leading-8 text-slate-600">
              The first E-commerce concept focuses on product discovery,
              featured collections, social proof, offer clarity, and a strong
              checkout path.
            </p>
          </AnimatedSection>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
            {liveWebsites.map((website) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 ${website.image ? "bg-gradient-to-t from-[#2e1065]/50 via-transparent to-transparent" : "bg-[linear-gradient(90deg,rgba(255,255,255,0.24)_1px,transparent_1px),linear-gradient(180deg,rgba(255,255,255,0.24)_1px,transparent_1px)] [background-size:44px_44px]"}`}
                  />
                ...
                <div className="p-8">
                  ...
                  <h3 className="mt-4 text-4xl font-black transition group-hover:text-[#7c3aed]">
                    {website.title}
                  </h3>
            ...
            <div className="border border-[#eadcff] bg-[#f3e8ff] p-8">
              <p className="text-sm font-black uppercase tracking-[0.22em] text-[#7c3aed]">
                E-commerce UX rules
              </p>
              <h3 className="mt-4 text-3xl font-black">
                Shoppers need reasons to keep moving.
              </h3>
      ...
      <section
        id="roadmap"
        className="border-y border-[#eadcff] bg-white py-20 md:py-28"
      >
        <Container>
          <AnimatedSection className="mb-12 flex flex-col justify-between gap-5 md:flex-row md:items-end">
            ...
            <p className="max-w-md text-sm leading-6 text-slate-600">
              These coming-soon cards keep the E-commerce category useful while
              the first store concept is live.
            </p>
          </AnimatedSection>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {comingSoonConcepts.map(([name, focus], index) => (
              <article
                key={name}
                className="group overflow-hidden border border-[#eadcff] bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl"
              >
                <div className="relative h-40 overflow-hidden bg-[linear-gradient(145deg,#fbf7ff,#7c3aed_58%,#ec4899)]">
                  ...
                  <div className="absolute bottom-4 left-[20%] h-20 w-20 rotate-6 rounded-2xl bg-white/25" />
                  <div className="absolute right-[18%] top-[24%] h-24 w-24 -rotate-6 rounded-full bg-white/20" />
                  <div className="absolute left-4 top-4 rounded-full bg-white/90 px-3 py-1 text-xs font-black uppercase tracking-[0.14em] text-[#7c3aed]">
                    Coming soon
                  </div>
                  <span className="absolute bottom-4 left-4 text-xs font-black uppercase tracking-[0.16em] text-white">
                    Concept {String(index + 2).padStart(2, "0")}
                  </span>
                </div>
                <div className="p-6">
                  ...
                  <Link
                    to={`/e-commerce/${name.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`}
                    className="mt-3 inline-flex items-center rounded-full border border-slate-300 bg-white px-3 py-1 text-xs font-black uppercase tracking-[0.2em] text-slate-600 transition hover:border-slate-400 hover:text-slate-900"
                  >
                    Coming soon
                  </Link>
                  ...
                  <p className="mt-4 text-sm leading-6 text-slate-600">
                    A product-led storefront direction combining clear
                    collections, trust cues, promotional rhythm, and a
                    friction-light buying path.
                  </p>
                  <div className="mt-5 flex gap-2 border-t border-slate-200 pt-5">
                    {["#7c3aed", "#fbf7ff", "#ec4899", "#17111f"].map(
                      (color) => (
                        <span
                          key={color}
                  ...
                  <span className="mt-5 inline-flex w-full cursor-not-allowed items-center justify-center rounded-lg bg-slate-100 px-4 py-3 text-sm font-bold text-slate-500">
                    Concept preview
                  </span>
                </div>
              </article>
