...
function IronHeading({
  ...
  return (
    <div className="max-w-4xl">
      <p className="flex items-center gap-3 text-[0.62rem] font-black uppercase tracking-[0.25em] text-[#D89A2B] before:h-1 before:w-9 before:bg-[#F6C945]">
        {label}
      </p>
      <h2
      ...
      {text && (
        <p
          className={`mt-6 max-w-2xl text-base leading-8 md:text-lg ${light ? "text-white/52" : "text-[#646970]"}`}
        >
          {text}
        </p>
      )}
...
function IronLogo() {
  return (
    ...
    >
      <span className="relative grid h-11 w-11 place-items-center border-2 border-[#F6C945] text-[#F6C945]">
        <Weight className="h-5 w-5" />
        <span className="absolute -bottom-1 -right-1 h-2.5 w-2.5 bg-[#F6C945]" />
      </span>
      <span>
        <strong className="block text-base font-black uppercase leading-none tracking-[-0.02em]">
          IronDistrict
        </strong>
        <span className="mt-1 block text-[0.5rem] font-black uppercase tracking-[0.26em] text-white/38">
          Strength Facility
        </span>
      </span>
    </a>
...
export function IronDistrictGym() {
  ...
  return (
    <main className="irondistrict-site -mt-16 overflow-hidden bg-[#C9CDD1] text-[#111318] selection:bg-[#F6C945] selection:text-[#0A0B0D]">
            ...
            {navLinks.map(([label, href]) => {
              ...
              return (
                <a
                  ...
                  className={`px-4 py-2 text-[0.64rem] font-black uppercase tracking-[0.14em] transition ${active ? "irondistrict-nav-active bg-[#F6C945] text-[#0A0B0D]" : "text-white/50 hover:bg-white/[0.06] hover:text-white"}`}
                >
                  {label}
                </a>
              );
      ...
      <section
        id="home"
        className="relative isolate overflow-hidden bg-[#0A0B0D] pt-[4.75rem] text-white"
      >
        <img
          src={heroImage}
          ...
          <div className="grid min-h-[46rem] gap-8 lg:grid-cols-[1fr_26rem] lg:items-stretch">
            <div className="flex flex-col justify-between">
              <div className="flex max-w-2xl flex-wrap items-center gap-3">
                <span className="bg-[#F6C945] px-4 py-2 text-[0.58rem] font-black uppercase tracking-[0.18em] text-[#0A0B0D]">
                  Strength Facility
                </span>
                <span className="border border-white/18 bg-white/[0.05] px-4 py-2 text-[0.58rem] font-black uppercase tracking-[0.18em] text-white/62">
                  Est. 2018
                </span>
                <span className="border border-white/18 bg-white/[0.05] px-4 py-2 text-[0.58rem] font-black uppercase tracking-[0.18em] text-white/62">
                  Open gym + coaching
              ...
              <div className="max-w-6xl py-12">
                ...
                <div className="mt-9 grid max-w-4xl gap-6 border-l-4 border-[#F6C945] pl-6 md:grid-cols-[1fr_auto] md:items-end">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row md:flex-col">
                    ...
                    <a
                      href="#membership"
                      className="inline-flex min-h-12 items-center justify-center gap-3 border border-white/25 bg-white/[0.03] px-6 text-xs font-black uppercase tracking-[0.16em] transition hover:border-[#F6C945] hover:text-[#F6C945]"
                    >
              ...
              <div className="grid max-w-4xl grid-cols-2 gap-px bg-white/14 p-px sm:grid-cols-4">
                {[
                  ...
                  <div
                    key={label}
                    className="bg-[#0A0B0D]/88 p-5 backdrop-blur"
                  >
                    <p className="text-3xl font-black text-[#F6C945]">
                      {value}
                    </p>
                    <p className="mt-2 text-[0.55rem] font-black uppercase tracking-[0.16em] text-white/48">
                      {label}
                    </p>
                  </div>
                ))}
            ...
            <aside className="grid gap-4 lg:grid-rows-[1fr_auto]">
              <div className="relative overflow-hidden border border-white/16 bg-white/[0.06] p-5 backdrop-blur-md">
                <div className="flex items-center justify-between border-b border-white/12 pb-4">
                  <p className="text-[0.58rem] font-black uppercase tracking-[0.18em] text-white/46">
                    Floor status
                  </p>
                  <span className="h-3 w-3 bg-[#F6C945]" />
                </div>
                <p className="mt-10 text-5xl font-black uppercase leading-[0.82] tracking-[-0.08em]">
                ...
                <div className="mt-10 grid gap-3">
                  {[
                    ...
                    <span
                      key={item}
                      className="flex items-center gap-3 border-t border-white/10 pt-3 text-xs font-black uppercase tracking-[0.12em] text-white/58"
                    >
                      <Check className="h-4 w-4 text-[#F6C945]" />
                      {item}
                    </span>
                  ))}
                </div>
      ...
      <section
        id="training"
        className="bg-[#E1E3E5] px-5 py-24 lg:px-10 lg:py-32"
      >
        <div className="mx-auto max-w-[96rem]">
          <div className="grid gap-8 lg:grid-cols-[.8fr_1.2fr] lg:items-end">
            ...
            />
            <p className="max-w-xl border-l-4 border-[#F6C945] pl-5 text-sm leading-7 text-[#555B62]">
              Four training lanes. One rule: every session should have a reason.
            </p>
          </div>
          <div className="mt-14 border-y-2 border-[#0A0B0D]">
            {programs.map((program) => (
              <article
                key={program.title}
                className="group grid gap-5 border-b border-[#8D9297] py-5 last:border-b-0 md:grid-cols-[4rem_.7fr_1fr_13rem_auto] md:items-center"
              >
                <span className="text-3xl font-black text-[#8C7200]">
                  {program.number}
                </span>
                <h3 className="text-3xl font-black uppercase leading-none tracking-[-0.055em]">
                  {program.title}
                </h3>
                <p className="text-sm leading-7 text-[#555B62]">
                  {program.text}
                </p>
                ...
                <a
                  ...
                  className="grid h-12 w-12 place-items-center border border-[#0A0B0D] transition group-hover:bg-[#F6C945]"
                >
      ...
      >
        <div className="mx-auto grid max-w-[96rem] gap-12 lg:grid-cols-[1.15fr_.85fr] lg:items-center">
          <div className="relative">
            ...
            />
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#0A0B0D] to-transparent p-7 pt-28">
              <p className="text-[0.6rem] font-black uppercase tracking-[0.2em] text-[#F6C945]">
                The training floor
              </p>
            ...
            <div className="mt-9 grid gap-3 sm:grid-cols-2">
              {[
                ...
                return (
                  <div
                    key={title as string}
                    className="border border-white/12 bg-white/[0.045] p-5"
                  >
                    <FeatureIcon className="h-5 w-5 text-[#F6C945]" />
                    <p className="mt-6 text-sm font-black uppercase tracking-[0.08em]">
                      {title as string}
                    </p>
                  </div>
                );
        ...
        <div className="mx-auto max-w-[96rem]">
          ...
          <div className="mt-12 grid gap-4 lg:grid-cols-3">
            {coaching.map((item) => (
              <article
                key={item.title}
                className="iron-card group overflow-hidden border border-[#AEB3B8] bg-[#C9CDD1]"
              >
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  />
                  <span className="absolute right-4 top-4 text-5xl font-black text-white/38">
                    {item.number}
                  </span>
                </div>
                <div className="p-7">
                  ...
                  <p className="mt-4 text-sm leading-7 text-[#555B62]">
                    {item.text}
                  </p>
                </div>
              </article>
      ...
      <section
        id="membership"
        className="relative bg-[#0A0B0D] px-5 py-24 text-white lg:px-10 lg:py-32"
      >
        <img
          src={membershipImage}
          alt=""
        ...
        <div className="relative mx-auto max-w-[96rem]">
          ...
          <div className="mt-14 grid gap-4 lg:grid-cols-3">
            {memberships.map((plan) => (
              <article
                key={plan.name}
                className={`relative flex flex-col border p-7 ${plan.popular ? "border-[#F6C945] bg-[#F6C945] text-[#0A0B0D] shadow-[12px_12px_0_rgba(255,255,255,.12)] lg:-translate-y-4" : "border-white/15 bg-[#17191D]"}`}
              >
                {plan.popular && (
                  <span className="absolute right-5 top-5 bg-[#0A0B0D] px-3 py-2 text-[0.58rem] font-black uppercase tracking-[0.14em] text-[#F6C945]">
                    Most Popular
                  </span>
                )}
                <p
                  className={`text-[0.6rem] font-black uppercase tracking-[0.18em] ${plan.popular ? "text-[#5A4700]" : "text-[#F6C945]"}`}
                >
                  District membership
                </p>
                <h3 className="mt-6 text-4xl font-black uppercase leading-none tracking-[-0.06em]">
                  {plan.name}
                </h3>
                <div className="mt-8 flex items-end gap-2">
                  ...
                  <span
                    className={`pb-2 text-xs font-bold ${plan.popular ? "text-black/50" : "text-white/35"}`}
                  >
                    / month
                  </span>
                </div>
                <p
                  className={`mt-5 text-sm leading-7 ${plan.popular ? "text-black/62" : "text-white/48"}`}
                >
                  {plan.text}
                </p>
                <div
                  className={`mt-6 grid gap-3 border-t pt-6 ${plan.popular ? "border-black/20" : "border-white/12"}`}
                >
                  {plan.features.map((feature) => (
                    ...
                    >
                      <Check
                        className={`h-4 w-4 ${plan.popular ? "text-black" : "text-[#F6C945]"}`}
                      />
                      {feature}
                    </span>
                  ))}
                ...
                <a
                  href="#contact"
                  className={`mt-8 inline-flex min-h-12 items-center justify-center px-5 text-xs font-black uppercase tracking-[0.14em] transition ${plan.popular ? "bg-[#0A0B0D] text-white hover:bg-[#25282D]" : "bg-[#F6C945] text-[#0A0B0D] hover:bg-[#ffda62]"}`}
                >
                  Choose {plan.name}
                </a>
              </article>
      ...
      <section className="relative bg-[#23262B] px-5 py-24 text-white lg:px-10 lg:py-32">
        <img
          src={cultureImage}
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#111318] via-[#111318]/92 to-[#111318]/55" />
        <div className="relative mx-auto max-w-[96rem]">
          <IronHeading
          ...
          <div className="mt-12 grid border-l border-t border-white/15 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              return (
                <div
                  key={title as string}
                  className="border-b border-r border-white/15 bg-black/30 p-6"
                >
                  <span className="text-xs font-black text-[#F6C945]">
                    0{index + 1}
                  </span>
                  <CultureIcon className="mt-10 h-6 w-6 text-[#F6C945]" />
      ...
      <section className="bg-[#C9CDD1] px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-[96rem]">
          <IronHeading
            label="Member log"
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-3">
            {[
              ...
              <blockquote
                key={name}
                className="border border-[#999FA5] bg-[#B9BEC3] p-7"
              >
                <span className="text-5xl font-black text-[#8F7200]">“</span>
                <p className="mt-4 text-lg font-semibold leading-8 text-[#292D32]">
                  {quote}
                </p>
                <footer className="mt-8 flex items-center gap-3 border-t border-[#969CA2] pt-5">
                  <span className="grid h-10 w-10 place-items-center bg-[#111318] text-xs font-black text-[#F6C945]">
                    0{index + 1}
                  </span>
                  <div>
                    <p className="font-black uppercase">{name}</p>
                    <p className="text-xs text-[#62686E]">District member</p>
                  </div>
                </footer>
              </blockquote>
            ))}
      ...
      <section
        id="contact"
        className="relative bg-[#0A0B0D] px-5 py-28 text-white lg:px-10 lg:py-36"
      >
        <img
          src={ctaImage}
      ...
      <footer className="border-t border-white/10 bg-[#07080A] px-5 pb-8 pt-14 text-white lg:px-10">
        <div className="mx-auto max-w-[96rem]">
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-4">
              {navLinks.map(([label, href]) => (
                <a
                  key={label}
                  href={href}
                  className="text-xs font-black uppercase tracking-[0.13em] text-white/40 hover:text-[#F6C945]"
                >
                  {label}
                </a>
              ))}
              ...
              <div className="mt-4 flex gap-2">
                {["IG", "YT", "TK"].map((social) => (
                  <a
                    ...
                    className="grid h-10 w-10 place-items-center border border-white/15 text-[0.6rem] font-black hover:border-[#F6C945] hover:text-[#F6C945]"
                  >
                    {social}
                  </a>
                ))}
