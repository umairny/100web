...
const images = {
  hero: imageUrl("fitness/resetRecoveryClub/hero.webp"),
  lounge: imageUrl("fitness/resetRecoveryClub/recovery-lounge.webp"),
  mobility: imageUrl("fitness/resetRecoveryClub/mobility-studio.webp"),
  compression: imageUrl("fitness/resetRecoveryClub/compression-recovery.webp"),
  journal: imageUrl("fitness/resetRecoveryClub/journal.webp"),
  results: imageUrl("fitness/resetRecoveryClub/calm-results.webp"),
  cta: imageUrl("fitness/resetRecoveryClub/cta.webp"),
};
...
const services = [
  {
    ...
    image: imageUrl("fitness/resetRecoveryClub/mobility-reset.webp"),
  },
  {
    title: "Assisted Stretch",
    length: "50 min",
    text: "Coach-supported stretching sessions for tight hips, shoulders, back, and daily tension.",
    image: imageUrl("fitness/resetRecoveryClub/assisted-stretch.webp"),
  },
  {
    ...
    image: imageUrl("fitness/resetRecoveryClub/compression-lounge.webp"),
  },
  {
    title: "Restoration Flow",
    length: "40 min",
    text: "Breath-led recovery, gentle movement, and downshift routines for calmer nervous system support.",
    image: imageUrl("fitness/resetRecoveryClub/restoration-flow.webp"),
  },
];
...
const methodSteps = [
  [
    "Scan",
    "Understand tightness, movement limits, routine stress, and training load.",
  ],
  [
    "Release",
    "Use mobility work, assisted stretching, and guided breathing to reduce unnecessary tension.",
  ],
  [
    "Restore",
    "Support circulation, downtime, and body awareness through recovery-focused sessions.",
  ],
...
const memberships = [
  ...
  },
  {
    ...
    features: [
      ...
      "Weekly assisted stretch",
      "Priority booking",
      "Monthly reset review",
    ],
  },
];
...
const journal = [
  [
    "How Mobility Supports Training Consistency",
    "Small mobility sessions can make your weekly movement feel more available and repeatable.",
  ],
  [
    "Building A Better Recovery Routine",
    "A calm plan for recovery days, compression, hydration, breathing, and simple reset habits.",
  ],
  [
    "Why Rest Days Need Structure",
    "Rest can feel more useful when it has gentle movement, quiet space, and clear intention.",
  ],
];
...
const testimonials = [
  [
    "“I finally have a mobility rhythm I can keep between workouts.”",
    "Nadia R.",
  ],
  [
    "“The compression lounge became my favorite post-training reset.”",
    "Marcus T.",
  ],
  [
    "“It feels quiet, premium, and genuinely easy to slow down here.”",
    "Leah S.",
  ],
];
...
function TimerRing({ value }: { value: number }) {
  return (
    <div
      ...
      style={{
        background: `conic-gradient(#75B7A6 ${value}%, #DDE7EA ${value}% 100%)`,
      }}
    >
      <div className="grid h-full w-full place-items-center rounded-full bg-white text-sm font-bold text-[#23313B]">
        {value}%
      </div>
    </div>
  );
    ...
    <main className="reset-recovery-site -mt-16 overflow-hidden bg-[#F6F8F7] text-[#23313B]">
        ...
        <div className="mx-auto grid max-w-[94rem] gap-12 lg:grid-cols-[.72fr_1.28fr] lg:items-start">
          <div className="sticky top-28">
            <SectionHeading
              ...
              text="A treatment menu for different kinds of tension, fatigue, and downtime needs."
            />
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="relative min-h-64 overflow-hidden rounded-[1.7rem] sm:min-h-0">
                  ...
                  <span className="absolute left-4 top-4 rounded-full bg-white/82 px-4 py-2 text-[0.58rem] font-bold uppercase tracking-[0.13em] text-[#23313B]">
                    {service.length}
                  </span>
                </div>
                <div className="flex flex-col justify-between p-5 sm:p-7">
                  ...
                  <a
                    href="#contact"
                    className="mt-6 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.15em] text-[#2F6E62]"
                  >
      ...
      >
        <div className="mx-auto grid max-w-[94rem] gap-12 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div className="relative min-h-[42rem] overflow-hidden rounded-[3rem] border border-white bg-white/45 p-3 shadow-xl">
            <img
              src={images.lounge}
              alt="Reset Recovery Club lounge"
              className="absolute inset-3 h-[calc(100%-1.5rem)] w-[calc(100%-1.5rem)] rounded-[2.5rem] object-cover"
            />
            ...
            <div className="absolute bottom-8 left-8 max-w-lg rounded-[1.8rem] bg-white/78 p-6 backdrop-blur-xl">
              <p className="text-[0.62rem] font-bold uppercase tracking-[0.2em] text-[#6EAFA0]">
                Club experience
              </p>
              <p className="mt-3 text-4xl font-semibold leading-none tracking-[-0.06em]">
                A quiet space before your comeback.
              </p>
            </div>
          </div>
          <div>
            <SectionHeading
              ...
              title="A Quiet Space Built For Your Comeback"
              text="Calm recovery rooms, soft lighting, premium recovery equipment, guided support, and space to slow down before returning to training or daily life."
            />
            <div className="mt-9 flex flex-wrap gap-3">
              {[
                ...
                <span
                  key={chip}
                  className="rounded-full border border-[#C9D3D6] bg-white/62 px-4 py-2 text-xs font-bold uppercase tracking-[0.13em] text-[#607075]"
                >
                  {chip}
                </span>
              ))}
      ...
      <section className="relative z-10 px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto grid max-w-[94rem] gap-12 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          <div className="relative min-h-[40rem] overflow-hidden rounded-[2.7rem] border border-white bg-white/48 p-3">
            <img
              src={images.compression}
              alt="Compression recovery tech lounge"
              className="absolute inset-3 h-[calc(100%-1.5rem)] w-[calc(100%-1.5rem)] rounded-[2.3rem] object-cover"
            />
              ...
              <div className="rounded-[1.5rem] bg-white/78 p-5 backdrop-blur-xl">
                ...
                <div className="mt-4 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#607075]">remaining</p>
                  </div>
                </div>
              </div>
              <div className="rounded-[1.5rem] bg-white/78 p-5 backdrop-blur-xl">
                ...
                {[68, 84, 52].map((bar, index) => (
                  <span
                    key={index}
                    className="mt-4 block h-2 rounded-full bg-[#DDE7EA]"
                  >
                    <span
                      className="block h-full rounded-full bg-[#75B7A6]"
                      style={{ width: `${bar}%` }}
                    />
                  </span>
                ))}
          ...
          <div>
            <SectionHeading
              label="Compression + Recovery Tech"
              title="Recovery Tech In A Calm Setting"
              text="Compression sessions, quiet lounge seating, hydration support, and warm/cool inspired recovery cues inside a space that still feels peaceful."
            />
            <div className="mt-9 grid gap-3">
              {[
                ...
                <div
                  key={item}
                  className="flex items-center gap-3 rounded-2xl border border-[#C9D3D6] bg-white/58 p-4"
                >
      ...
      >
        <div className="mx-auto max-w-[94rem]">
          <SectionHeading
            label="Membership"
            title="Build Recovery Into Your Rhythm"
          />
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
            {memberships.map((plan) => (
              ...
              >
                ...
                <p
                  className={`mt-4 text-sm leading-7 ${plan.popular ? "text-white/68" : "text-[#607075]"}`}
                >
                  {plan.text}
                </p>
                <div
                  className={`mt-8 grid gap-3 border-t pt-7 ${plan.popular ? "border-white/15" : "border-[#C9D3D6]"}`}
                >
                  {plan.features.map((feature) => (
                    ...
                    >
                      <Check
                        className={`h-4 w-4 ${plan.popular ? "text-[#A8D7C9]" : "text-[#75B7A6]"}`}
                      />
                      {feature}
                    </span>
                  ))}
      ...
      <section className="relative z-10 bg-[#EAF1F2] px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto grid max-w-[94rem] gap-12 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          <div>
            <SectionHeading
              label="Calm Results"
              title="Feel The Difference In Your Routine"
            />
            <div className="mt-10 grid gap-4">
              {results.map((item, index) => (
                <div
                  key={item}
                  className="flex items-center gap-4 rounded-[1.5rem] border border-white/80 bg-white/62 p-5"
                >
                  <span className="grid h-10 w-10 place-items-center rounded-full bg-[#DDEBE8] text-sm font-bold text-[#2F6E62]">
                    0{index + 1}
                  </span>
      ...
      <section className="relative z-10 px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-[94rem]">
          <SectionHeading
            label="Member Notes"
            title="A Quiet Place To Return To"
          />
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {testimonials.map(([quote, name]) => (
              ...
              >
                ...
                <footer className="mt-8 border-t border-[#C9D3D6] pt-5 text-sm font-bold text-[#2F6E62]">
                  {name}
                </footer>
              </blockquote>
            ))}
        ...
        <div className="mx-auto overflow-hidden rounded-[3rem] border border-white bg-white/50 shadow-[0_28px_90px_rgba(35,49,59,.13)] lg:grid lg:max-w-[94rem] lg:grid-cols-[1fr_.85fr]">
          <div className="p-8 sm:p-12 lg:p-16">
            ...
            <p className="mt-7 max-w-xl text-lg leading-8 text-[#607075]">
              Book a calm recovery session designed to help you slow down, move
              better, and return with more ease.
            </p>
            <ResetButton
              href="mailto:book@resetrecovery.example"
              className="mt-9"
            >
              Book A Reset
            </ResetButton>
          ...
          <div className="relative min-h-[32rem]">
            <img
              src={images.cta}
              alt="Reset Recovery Club calming treatment room"
              className="absolute inset-0 h-full w-full object-cover"
            />
      ...
      <footer className="relative z-10 border-t border-[#C9D3D6] px-5 py-12 lg:px-10">
        <div className="mx-auto flex max-w-[94rem] flex-col justify-between gap-8 lg:flex-row lg:items-start">
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm leading-7 text-[#607075]">
              Mobility, recovery, and restoration for better daily movement.
            </p>
          </div>
          ...
          <div>
            <p className="text-[0.58rem] font-bold uppercase tracking-[0.18em] text-[#809095]">
              Social
            </p>
            <div className="mt-3 flex gap-2">
              {["IG", "LI", "YT"].map((social) => (
                <a
                  ...
                  className="grid h-10 w-10 place-items-center rounded-full border border-[#C9D3D6] text-[0.6rem] font-bold text-[#607075] hover:border-[#75B7A6] hover:text-[#2F6E62]"
                >
                  {social}
                </a>
              ))}
        ...
        <p className="mx-auto mt-10 max-w-[94rem] text-xs text-[#809095]">
          © 2026 Reset Recovery Club. Sessions support wellness routines and do
