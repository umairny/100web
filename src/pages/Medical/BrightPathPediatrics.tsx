...
const services: Array<{
  ...
  },
  {
    ...
    icon: Heart,
    image: "medical/BrightPath/wellness-visits.webp",
    color: "bg-[#e9f8ff]",
  },
  {
    title: "Sick Visits",
    ...
    icon: Stethoscope,
    image: "medical/BrightPath/sick-visits.webp",
    color: "bg-[#fff0e9]",
  },
  {
    ...
    icon: Syringe,
    image: "medical/BrightPath/vaccination-guidance.webp",
    color: "bg-[#eef0ff]",
  },
  {
...
const visitDetails = [
  [
    "What to bring",
    "Bring forms, medication lists, questions, and any recent records you want the team to review.",
  ],
  [
    "New patient visits",
    "First visits include extra time to learn your child history, routines, and family priorities.",
  ],
  [
    "Sick visit timing",
    "Same-week options help families get guidance for common concerns when care should not wait.",
  ],
  [
    "Follow-up care",
    "Families leave with practical next steps and timing for future appointments when needed.",
  ],
  [
    "Parent communication",
    "The team keeps explanations clear so parents know what to watch for and what to do next.",
  ],
  [
    "Emergency note",
...
const resources = [
  [
    ...
    "What to bring, how to share concerns, and how to help your child feel ready.",
  ],
  [
    "Understanding wellness checkups",
    "A simple overview of routine visits, growth conversations, and prevention.",
  ],
  [
    "When to schedule a sick visit",
    "Parent-friendly guidance on when a clinic visit may be the right next step.",
  ],
  [
    "Building healthy routines",
    "Ideas for sleep, movement, meals, and everyday family rhythms.",
  ],
];
...
const reviews = [
  {
    name: "Alyssa",
    quote:
      "They were patient with my child and explained everything in a way I could actually use at home.",
  },
  {
    name: "Jordan",
    quote:
      "The visit felt organized from the first call, and I left knowing exactly what the next steps were.",
  },
  {
    name: "Mina",
    quote:
      "The clinic felt bright and welcoming, and the team made space for all of my parent questions.",
  },
];
...
const IconBadge = ({
  ...
  <span
    className={`inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl ${className || "bg-[#e7f6ff] text-[#316a9f]"}`}
  >
  ...
  return (
    <main className="brand-motion bg-[#fffaf0] text-[#263452]">
      ...
      <section className="relative isolate overflow-hidden pt-28 md:pt-32">
        <img
          src={imageUrl("medical/BrightPath/bg.webp")}
          alt=""
          aria-hidden="true"
          ...
          <div className="grid gap-10 rounded-[2.5rem] border border-white/70 bg-white/58 p-4 shadow-2xl shadow-[#263452]/8 backdrop-blur md:p-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
            <div className="px-2 py-6 md:px-6 lg:py-10">
              <p className="inline-flex items-center gap-2 rounded-full bg-[#fff2b8] px-4 py-2 text-sm font-black text-[#765b10] shadow-sm ring-1 ring-[#f0d986]">
                <Sparkles aria-hidden="true" size={17} /> Family-first pediatric
                care
              </p>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-[#5f6b83] md:text-xl">
                From newborn visits to sick care and wellness checkups,
                BrightPath Pediatrics gives parents clear guidance, practical
                next steps, and a caring team they can trust.
              </p>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <CTAButton
                  href="#contact"
                  size="lg"
                  className="bg-[#3f65a8] text-white hover:bg-[#304f86]"
                >
                  Book a Visit
                </CTAButton>
                <CTAButton
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                {trustPoints.map((point) => (
                  <div
                    key={point}
                    className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-3 text-sm font-black text-[#4f5e77] shadow-sm ring-1 ring-[#f3ddc8]"
                  >
                    <CheckCircle
                      aria-hidden="true"
                      className="text-[#65a98a]"
                      size={18}
                    />
                    {point}
                  </div>
            ...
            <div className="relative min-h-[34rem] overflow-hidden rounded-[2rem] bg-[#e9f8ff] p-3">
              ...
              <img
                src={imageUrl("medical/BrightPath/hero.webp")}
              ...
              <div className="absolute bottom-5 left-5 right-5 grid gap-3 sm:grid-cols-[1fr_0.82fr]">
                <div className="rounded-3xl bg-white/94 p-5 shadow-xl shadow-[#263452]/12 backdrop-blur">
                  <p className="text-sm font-black uppercase text-[#b47243]">
                    Parent note
                  </p>
                  <p className="mt-2 text-2xl font-black leading-tight text-[#263452]">
                    Simple visit options for real family schedules.
                  </p>
                </div>
                <div className="rounded-3xl bg-[#dcd8ff]/95 p-5 shadow-xl shadow-[#263452]/10 backdrop-blur">
                  <p className="text-sm font-black uppercase text-[#5f5aa2]">
                    Next step
                  </p>
                  <p className="mt-2 text-lg font-black leading-tight text-[#263452]">
                    Questions welcomed before and after the visit.
                  </p>
                </div>
              </div>
              <div className="absolute -right-6 top-24 hidden rotate-3 rounded-[1.5rem] bg-[#fff2b8] p-3 shadow-xl shadow-[#263452]/12 sm:block">
                <img
                  src={imageUrl("medical/BrightPath/clinic-play-area.webp")}
      ...
      <section id="services" className="py-20 md:py-28">
        <Container>
          <div className="mb-12 max-w-3xl">
            <p className="text-sm font-black uppercase text-[#3f65a8]">
              Services
            </p>
            <h2 className="mt-3 text-4xl font-black leading-tight text-[#263452] md:text-5xl">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {services.map(({ title, text, icon: Icon, image, color }) => (
              <article
                key={title}
                className={`overflow-hidden rounded-[1.75rem] ${color} shadow-sm shadow-[#263452]/6 ring-1 ring-[#f3ddc8]`}
              >
                <img
                  src={imageUrl(image)}
                  alt=""
                ...
                <div className="p-6">
                  ...
                  <h3 className="mt-5 text-2xl font-black text-[#263452]">
                    {title}
                  </h3>
                  <p className="mt-3 text-sm leading-7 text-[#5f6b83]">
                    {text}
                  </p>
                </div>
              </article>
        ...
        <Container>
          <div className="relative grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div className="relative">
              ...
              <h2 className="mt-3 text-4xl font-black leading-tight text-[#263452] md:text-5xl">
                A calmer appointment path for parents.
              </h2>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-[#5f6b83]">
                Booking should feel clear before families arrive. BrightPath
                keeps the visit type, timing, and follow-up expectations easy to
                understand.
              </p>
              <div className="relative mt-8 overflow-hidden rounded-[2rem] bg-[#fff7d8] p-3 shadow-xl shadow-[#263452]/9 ring-1 ring-[#f3ddc8]">
                <img
                  src={imageUrl("medical/BrightPath/appointment.webp")}
                ...
                <div className="absolute bottom-6 left-6 right-6 rounded-3xl bg-white/94 p-5 shadow-xl shadow-[#263452]/12 backdrop-blur sm:right-auto sm:max-w-sm">
                  <p className="text-sm font-black uppercase text-[#d58b55]">
                    Today&apos;s path
                  </p>
                  <p className="mt-2 text-2xl font-black leading-tight text-[#263452]">
                    Pick a visit, meet the team, leave with next steps.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative rounded-[2rem] bg-[#f7fbff] p-4 shadow-sm ring-1 ring-[#d6e8f5] md:p-5">
              ...
              {steps.map(({ title, text }, index) => (
                <article
                  key={title}
                  className="relative mb-4 rounded-3xl bg-white p-5 shadow-sm shadow-[#263452]/5 ring-1 ring-[#e3edf7] last:mb-0 sm:p-6"
                >
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <h3 className="mt-2 text-2xl font-black text-[#263452]">
                        {title}
                      </h3>
              ...
              <div className="mt-5 rounded-3xl bg-[#fff2d9] p-5 ring-1 ring-[#f3ddc8]">
                ...
                <p className="mt-2 text-sm leading-6 text-[#5f6b83]">
                  For urgent or life-threatening symptoms, call local emergency
                  services.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 md:py-28">
        <Container>
          <div className="mb-12 max-w-3xl">
            ...
            <h2 className="mt-3 text-4xl font-black leading-tight text-[#263452] md:text-5xl">
              Parent questions answered up front.
            </h2>
          </div>
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {visitDetails.map(([title, text]) => (
              <article
                key={title}
                className="rounded-3xl bg-white p-6 shadow-sm shadow-[#263452]/5 ring-1 ring-[#f3ddc8]"
              >
        ...
        <Container>
          <div className="mb-12 grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-black leading-tight text-[#263452] md:text-5xl">
                A pediatric team families can trust.
              </h2>
            </div>
            <p className="max-w-2xl text-lg leading-8 text-[#5f6b83]">
              Warm introductions help parents understand who will listen,
              explain, and guide care.
            </p>
          </div>
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <img
              src={imageUrl("medical/BrightPath/pediatric-team.webp")}
            ...
            <div className="grid gap-5">
              {providers.map(({ name, role, bio }) => (
                <article
                  key={name}
                  className="rounded-3xl bg-white p-6 shadow-sm shadow-[#263452]/5 ring-1 ring-[#d6e8f5]"
                >
                  <h3 className="text-2xl font-black text-[#263452]">{name}</h3>
                  <p className="mt-1 text-sm font-black text-[#3f65a8]">
                    {role}
                  </p>
        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-black leading-tight text-[#263452] md:text-5xl">
                Helpful guidance between appointments.
              </h2>
              <img
                src={imageUrl("medical/BrightPath/parent-resources.webp")}
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {resources.map(([title, text]) => (
                ...
                >
                  <BookOpen
                    aria-hidden="true"
                    className="text-[#d58b55]"
                    size={26}
                  />
                  <h3 className="mt-5 text-xl font-black text-[#263452]">
                    {title}
                  </h3>
                  <p className="mt-3 text-sm leading-7 text-[#5f6b83]">
                    {text}
        ...
        <Container className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="grid gap-4 sm:grid-cols-2">
            <img
              ...
              className="h-80 w-full rounded-[2rem] object-cover shadow-xl shadow-[#263452]/9"
            />
            <img
              src={imageUrl("medical/BrightPath/family-consultation.webp")}
              alt="Parent consultation moment"
              className="h-80 w-full rounded-[2rem] object-cover shadow-xl shadow-[#263452]/9 sm:mt-10"
            />
          </div>
          <div>
            <p className="text-sm font-black uppercase text-[#3f65a8]">
            ...
            <h2 className="mt-3 text-4xl font-black leading-tight text-[#263452] md:text-5xl">
              A bright space designed for kids and parents.
            </h2>
            <p className="mt-5 text-lg leading-8 text-[#5f6b83]">
              The clinic environment is welcoming for children and organized for
              parents, with friendly spaces that help families feel comfortable
              and informed.
            </p>
          </div>
        </Container>
        ...
        <Container>
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {reviews.map(({ name, quote }) => (
              <blockquote
                key={name}
                className="rounded-3xl bg-white p-7 shadow-sm shadow-[#263452]/5 ring-1 ring-[#f3ddc8]"
              >
                <p className="text-5xl font-black leading-none text-[#d58b55]">
                  &ldquo;
                </p>
                <p className="mt-2 text-lg font-bold leading-8 text-[#263452]">
                  {quote}
                </p>
                <footer className="mt-6 text-sm font-black uppercase text-[#3f65a8]">
                  {name}
                </footer>
              </blockquote>
            ))}
      ...
      <section className="bg-[#5f5aa2] py-20 text-white md:py-28">
        <Container className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase text-[#fff2b8]">
              Appointment access
            </p>
            <h2 className="mt-3 text-4xl font-black leading-tight md:text-5xl">
              Simple appointments for busy families.
            </h2>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <CTAButton
                href="#contact"
                size="lg"
                className="bg-[#fff2b8] text-[#263452] hover:bg-white"
              >
                Book a Visit
              </CTAButton>
            </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {accessItems.map((item) => (
              <div
                key={item}
                className="flex items-center gap-3 rounded-2xl bg-white/12 p-4 ring-1 ring-white/16"
              >
                <CheckCircle
                  aria-hidden="true"
                  className="text-[#fff2b8]"
                  size={20}
                />
      ...
      <section
        id="contact"
        className="relative isolate overflow-hidden bg-[#263452] py-20 text-white md:py-28"
      >
        <img
          src={imageUrl("medical/BrightPath/cta.webp")}
          alt=""
          aria-hidden="true"
        ...
        <Container className="max-w-5xl">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/76">
            Book a visit with BrightPath Pediatrics and get friendly care,
            practical answers, and guidance made for real family life.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <CTAButton
              href="mailto:hello@brightpath.example"
              size="lg"
              className="bg-[#fff2b8] text-[#263452] hover:bg-white"
            >
              Book a Visit
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr_1fr]">
            ...
            <div className="grid gap-3 text-sm text-white/72">
              <p className="flex gap-3">
                <MapPin
                  aria-hidden="true"
                  className="mt-0.5 shrink-0 text-[#fff2b8]"
                  size={18}
                />
              ...
              <p className="flex gap-3">
                <Phone
                  ...
                  size={18}
                />
                <a href="tel:5550193267" className="hover:text-white">
                  (555) 019-3267
                </a>
              </p>
            </div>
