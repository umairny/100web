...
const heroSlides = [
  {
    ...
    image: "medical/clearskin/hero.webp",
  ...
  },
  {
    ...
    image: "medical/clearskin/skin-consultation.webp",
  ...
  },
  {
    ...
    image: "medical/clearskin/room.webp",
...
const flowSteps = [
  [
    "Share your concern",
    "Tell the team what you are noticing, how long it has been happening, and what questions you want answered.",
  ],
  [
    "Review your skin history",
    "Your provider reviews relevant history, routines, prior care, and practical visit details.",
  ],
  [
    "Discuss care options",
    "Your provider explains possible next steps in plain language and answers questions.",
  ],
  [
    "Leave with a plan",
    "You receive practical guidance for follow-up, care routines, treatment discussions, or referrals when appropriate.",
  ],
];
...
const visitDetails = [
  [
    "What to bring",
    "Bring current product lists, medications, photos if helpful, questions, and payment details.",
  ],
  [
    "First consultation",
    "Your first visit may review concerns, history, routines, goals, and practical next steps.",
  ],
  [
    "Skin concern visits",
    "Concern-focused visits help organize symptoms, timelines, questions, and provider review.",
  ],
  [
    "Follow-up appointments",
    "Follow-ups can review progress conversations, routine questions, and care-plan details.",
  ],
  [
    "Product routine notes",
    "Bring names or photos of products you currently use so the team can review context.",
  ],
  [
...
const reviews = [
  {
    name: "Iris",
    quote:
      "The visit felt organized, and I understood the next steps for follow-up before I left.",
  },
  {
    name: "Maren",
    quote:
      "The provider explained my options clearly and helped me understand what to track.",
  },
  {
    name: "Theo",
    quote:
      "The consultation felt calm, practical, and focused on what I needed to ask.",
  },
];
        ...
        <Container className="flex min-h-[calc(100vh-8rem)] flex-col justify-center gap-8 py-10">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-white/78 md:text-xl">
              ClearSkin Dermatology helps patients understand skin concerns,
              prepare for visits, review care options, and leave with practical
              next steps from a provider-led dermatology team.
            </p>
          ...
          <div className="mx-auto grid w-full max-w-6xl gap-4 lg:grid-cols-[0.78fr_1.44fr_0.78fr] lg:items-end">
            ...
            <div className="grid gap-3 border border-white/18 bg-white/10 p-4 shadow-2xl shadow-black/22 backdrop-blur md:grid-cols-3">
              {trustPoints.map((point) => (
                <div
                  key={point}
                  className="border border-white/14 bg-white/10 p-4 text-center text-sm font-bold text-white/82"
                >
                  <CheckCircle
                    aria-hidden="true"
            ...
            <div className="border border-white/22 bg-white/90 p-5 text-[#2b2520] shadow-2xl shadow-black/18 backdrop-blur">
              ...
              <div className="mt-4 grid gap-3">
                {["Discuss concern", "Review options", "Plan next steps"].map(
                  (step, index) => (
                    <div
                      key={step}
        ...
        <Container>
          <div className="mb-12 grid gap-8 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
            ...
            <p className="max-w-2xl text-lg leading-8 text-white/66">
              A clean sequence keeps dermatology visits focused on what the
              patient noticed, what the provider reviews, and what practical
              guidance comes next.
            </p>
          </div>
          <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:items-stretch">
            <img
              src={imageUrl("medical/clearskin/consultation-flow.webp")}
      ...
      >
        ...
        <Container className="max-w-5xl">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/76">
            Book a consultation with ClearSkin Dermatology and get clear
            guidance, practical visit details, and a care path built around your
            skin concerns.
          </p>
          ...
          <p className="mt-6 text-sm leading-6 text-white/70">
            If you are experiencing a life-threatening emergency or severe
            allergic reaction symptoms, call local emergency services
            immediately.
          </p>
        </Container>
      </section>
          ...
          <div className="grid gap-8 md:grid-cols-[1.1fr_0.9fr_1fr]">
            <div>
              ...
              <p className="mt-3 max-w-md leading-7 text-white/68">
                Medical skin care and consultation flow for patient-first
                dermatology.
              </p>
