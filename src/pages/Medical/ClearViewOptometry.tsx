...
const services: Array<{
  ...
  },
  {
    ...
    icon: RefreshCw,
    image: "medical/clearview/exam-room.webp",
  },
  {
...
const examFlow = [
  [
    "Book your exam",
    "Choose a visit type and share the basics before you arrive.",
  ],
  [
    "Understand your vision needs",
    "Review prescription questions, screen habits, contacts, and day-to-day priorities.",
  ],
  [
    "Choose eyewear with confidence",
    "Move from exam notes to frame options with calm styling support.",
  ],
];
...
const frameCategories = [
  [
    "Everyday Classics",
    "Clean shapes and reliable fits for workdays, errands, and daily wear.",
    "medical/clearview/retail-frames.webp",
    "View Frames",
  ],
  [
    "Lightweight Minimal",
    "Subtle profiles for patients who prefer barely-there styling.",
    "medical/clearview/eyewear-display.webp",
    "View Frames",
  ],
  [
    "Bold Modern",
    "Stronger silhouettes for expressive style without losing comfort.",
    "medical/clearview/frame-styling.webp",
    "Get Styling Help",
  ],
  [
    "Sunwear & Specialty",
    "Lens and frame options for bright days, driving, and specific routines.",
    "medical/clearview/hero.webp",
    "Get Styling Help",
  ],
];
...
const visitDetails = [
  [
    "What to bring",
    "Bring current eyewear, contact lens details if applicable, ID, and any vision questions.",
  ],
  [
    "New patient exams",
    "Plan for a clear intake, routine exam flow, and time for practical questions.",
  ],
  [
    "Prescription updates",
    "Share what has changed so the team can review your current vision needs.",
  ],
  [
    "Contact lens appointments",
    "Bring current lens details and notes about comfort, routine, or fit questions.",
  ],
  [
    "Eyewear pickup",
    "The team reviews fit, basic care, and practical adjustment questions at pickup.",
  ],
  [
    "Follow-up questions",
    "Contact the office to review payment and plan details before your visit.",
  ],
];
...
const reviews = [
  {
    name: "Maya",
    quote:
      "The visit felt organized, and the frame help made it easier to choose something I would actually wear.",
  },
  {
    name: "Jon",
    quote:
      "I liked that the team explained the appointment steps clearly and gave me time for questions.",
  },
  {
    name: "Elena",
    quote:
      "The eyewear area felt boutique without feeling overwhelming. The guidance was simple and useful.",
  },
];
  ...
  return (
    <main className="brand-motion bg-[#f7fbfa] text-[#1e2a36]">
      ...
      <section className="relative isolate overflow-hidden bg-[#111d27] pt-28 text-white md:pt-32">
        <img
          src={imageUrl("medical/clearview/hero.webp")}
          alt=""
          aria-hidden="true"
        ...
        <Container className="grid min-h-[calc(100vh-5.5rem)] gap-10 py-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/76 md:text-xl">
              ClearView Optometry brings together thorough eye exams, helpful
              guidance, and curated eyewear so patients can move from
              appointment to frame selection with confidence.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <CTAButton
                href="#contact"
                size="lg"
                className="bg-[#d9c49e] text-[#111d27] hover:bg-white"
              >
                Book Eye Exam
              </CTAButton>
              <CTAButton
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              {trustPoints.map((point) => (
                <div
                  key={point}
                  className="rounded-2xl bg-white/10 p-4 text-sm font-black text-white/86 ring-1 ring-white/14 backdrop-blur"
                >
                  <CheckCircle
                    aria-hidden="true"
                    className="mb-2 text-[#d9c49e]"
                    size={19}
                  />
                  {point}
                </div>
          ...
          <div className="grid gap-4 lg:grid-cols-[0.72fr_1fr] lg:items-end">
            <div className="order-2 grid gap-4 lg:order-1">
              <div className="rounded-[1.5rem] border border-white/14 bg-white/10 p-5 shadow-xl shadow-black/18 backdrop-blur">
                <p className="text-xs font-black uppercase text-[#d9c49e]">
                  Next visit
                </p>
                <p className="mt-2 text-2xl font-black leading-tight">
                  Exam, eyewear, and contact lens guidance in one place.
                </p>
                <a
                  href="#contact"
                  className="mt-5 inline-flex items-center gap-2 text-sm font-black text-white hover:text-[#d9c49e]"
                >
                  Book Eye Exam <ArrowRight aria-hidden="true" size={17} />
                </a>
              </div>
              <img
                src={imageUrl("medical/clearview/eyewear-display.webp")}
            ...
            <div className="relative order-1 lg:order-2">
              <img
                src={imageUrl("medical/clearview/frame-styling.webp")}
              ...
              <div className="absolute bottom-5 left-5 right-5 rounded-[1.25rem] border border-white/72 bg-white/94 p-5 text-[#1e2a36] shadow-xl shadow-black/16 backdrop-blur">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <p className="text-xs font-black uppercase text-[#2f6f9f]">
                      Visit flow
                    </p>
                    <p className="mt-1 text-lg font-black">
                      From exam to frame pickup
                    </p>
                  </div>
                  <Glasses
                    aria-hidden="true"
                    className="shrink-0 text-[#2f6f9f]"
                    size={28}
                  />
                </div>
                <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-4">
                  {visitFlow.map((step, index) => (
                    <div
                      key={step}
                      className="rounded-2xl bg-[#f5faf9] p-3 ring-1 ring-[#dbe7e6]"
                    >
                      <span className="text-xs font-black text-[#9a8a64]">
                        0{index + 1}
                      </span>
                      <p className="mt-1 text-sm font-black text-[#1e2a36]">
                        {step}
                      </p>
                    </div>
                  ))}
        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
            <div className="lg:sticky lg:top-36">
              <p className="text-sm font-black uppercase text-[#2f6f9f]">
                Services
              </p>
              ...
              <p className="mt-5 text-lg leading-8 text-[#5e6c78]">
                Patients can move from exam questions to prescription updates,
                contact lens guidance, and frame selection without sorting
                through a complicated care menu.
              </p>
              <div className="mt-8 overflow-hidden rounded-[1.75rem] border border-[#dbe7e6] bg-white shadow-xl shadow-[#1e2a36]/8">
                <img
                  src={imageUrl("medical/clearview/eye-exam.webp")}
                ...
                <div className="grid grid-cols-3 divide-x divide-[#dbe7e6] text-center">
                  {["Exam", "Lens", "Frames"].map((item) => (
                    <div key={item} className="p-4">
                      <p className="text-sm font-black text-[#2f6f9f]">
                        {item}
                      </p>
                    </div>
                  ))}
              ...
              {services.map(({ title, text, icon, image }, index) => (
                ...
                >
                  ...
                  <div className="flex gap-4 p-1 sm:p-3">
                    <IconTile icon={icon} />
                    <div>
                      <h3 className="text-2xl font-black text-[#1e2a36]">
                        {title}
                      </h3>
                      <p className="mt-2 text-sm leading-7 text-[#5e6c78]">
                        {text}
                      </p>
                      <a
                        href="#contact"
                        className="mt-4 inline-flex items-center gap-2 text-sm font-black text-[#2f6f9f] hover:text-[#1e2a36]"
                      >
                        Plan this visit{" "}
      ...
      <section className="bg-white py-20 md:py-28">
        <Container className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          <img
            src={imageUrl("medical/clearview/exam-room.webp")}
      ...
      <section
        id="eyewear"
        className="overflow-hidden bg-[#111d27] py-20 text-white md:py-28"
      >
        <Container>
          <div className="grid gap-10 lg:grid-cols-[0.94fr_1.06fr] lg:items-center">
            <div>
              <p className="text-sm font-black uppercase text-[#d9c49e]">
                Eyewear retail
              </p>
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-white/72">
                The optical experience keeps frame selection visual, easy to
                compare, and supported by practical styling guidance.
              </p>
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {["Fit first", "Style guidance", "Daily comfort"].map(
                  (item) => (
                    <div
                      key={item}
                      className="rounded-2xl bg-white/10 p-4 text-sm font-black text-white/82 ring-1 ring-white/14"
                    >
                      <Glasses
                        aria-hidden="true"
                        className="mb-2 text-[#d9c49e]"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <article className="group overflow-hidden rounded-[1.75rem] bg-white text-[#1e2a36] shadow-2xl shadow-black/18 sm:col-span-2">
                <div className="grid gap-0 md:grid-cols-[1.08fr_0.92fr]">
                  <img
                    src={imageUrl("medical/clearview/retail-frames.webp")}
                  ...
                  <div className="p-6 md:p-8">
                    ...
                    <h3 className="mt-3 text-3xl font-black leading-tight">
                      Start with the way you wear them.
                    </h3>
                    <p className="mt-4 text-sm leading-7 text-[#5e6c78]">
                      Compare everyday, minimal, bold, and sunwear options with
                      a stylist who can help narrow the wall into practical
                      choices.
                    </p>
                    <a
                      href="#contact"
                      className="mt-6 inline-flex items-center gap-2 text-sm font-black text-[#2f6f9f] hover:text-[#1e2a36]"
                    >
              ...
              {frameCategories.map(([title, text, image, cta]) => (
                <article
                  key={title}
                  className="group overflow-hidden rounded-[1.5rem] bg-white/10 ring-1 ring-white/14 backdrop-blur"
                >
                  <img
                    src={imageUrl(image)}
                    alt=""
                    className="h-44 w-full object-cover opacity-92 transition duration-500 group-hover:scale-105"
                  />
                  <div className="p-5">
                    ...
                    <a
                      href="#contact"
                      className="mt-4 inline-flex items-center gap-2 text-sm font-black text-[#d9c49e] hover:text-white"
                    >
      ...
      <section id="doctors" className="bg-[#eef7f8] py-20 md:py-28">
        <Container className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase text-[#2f6f9f]">
              Doctors and styling support
            </p>
            <h2 className="mt-3 text-4xl font-black leading-tight text-[#1e2a36] md:text-5xl">
              Guidance from exam room to frame wall.
            </h2>
            <img
              src={imageUrl("medical/clearview/optometry-team.webp")}
          ...
          <div className="grid gap-5">
            {providers.map(({ name, role, bio }) => (
              <article
                key={name}
                className="rounded-[1.5rem] border border-[#d1e5e8] bg-white p-6 shadow-sm shadow-[#1e2a36]/5"
              >
        ...
        <Container>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {visitDetails.map(([title, text]) => (
              <article
                key={title}
                className="rounded-[1.35rem] border border-[#dbe7e6] bg-white p-5 shadow-sm shadow-[#1e2a36]/5"
              >
                <IconTile
                  icon={
                ...
                />
                <h3 className="mt-5 text-xl font-black text-[#1e2a36]">
                  {title}
                </h3>
      ...
      <section id="contacts" className="bg-white py-20 md:py-28">
        <Container className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <img
            src={imageUrl("medical/clearview/contact-lens-care.webp")}
          ...
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-[#5e6c78]">
              Contact lens appointments can include fittings, follow-up timing,
              comfort questions, care routines, prescription updates, and
              practical next steps for daily use.
            </p>
            <p className="mt-5 rounded-2xl border border-[#dbe7e6] bg-[#f7fbfa] p-5 text-sm leading-7 text-[#5e6c78]">
              For sudden or urgent vision changes, contact a licensed eye care
          ...
          <div>
            ...
            <div className="mt-8">
              <CTAButton
                href="#contact"
                size="lg"
                className="bg-[#d9c49e] text-[#1e2a36] hover:bg-white"
              >
                Book Eye Exam
              </CTAButton>
            </div>
      ...
      <section id="reviews" className="py-20 md:py-28">
        <Container>
          <div className="mb-12 grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            ...
            <img
              src={imageUrl("medical/clearview/appointment.webp")}
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {reviews.map(({ name, quote }) => (
              <blockquote
                key={name}
                className="rounded-[1.5rem] border border-[#dbe7e6] bg-white p-7 shadow-sm shadow-[#1e2a36]/5"
              >
                <p className="text-5xl font-black leading-none text-[#d9c49e]">
                  &ldquo;
                </p>
                <p className="mt-2 text-lg font-bold leading-8 text-[#1e2a36]">
                  {quote}
                </p>
                <footer className="mt-6 text-sm font-black uppercase text-[#2f6f9f]">
                  {name}
                </footer>
              </blockquote>
            ))}
      ...
      <section
        id="contact"
        className="relative isolate overflow-hidden bg-[#1e2a36] py-20 text-white md:py-28"
      >
        <img
          src={imageUrl("medical/clearview/cta.webp")}
          alt=""
          aria-hidden="true"
          className="absolute inset-0 -z-20 h-full w-full object-cover opacity-30"
        />
        ...
        <Container className="max-w-5xl">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/76">
            Start with a simple eye exam and get practical guidance for
            prescriptions, eyewear, contact lenses, and ongoing vision care.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <CTAButton
              href="mailto:hello@clearview.example"
              size="lg"
              className="bg-[#d9c49e] text-[#1e2a36] hover:bg-white"
            >
              Book Eye Exam
          ...
          <div className="grid gap-8 md:grid-cols-[1.15fr_0.85fr_1fr]">
            ...
            <div className="grid gap-3 text-sm text-white/72">
              <p className="flex gap-3">
                <MapPin
                  aria-hidden="true"
                  className="mt-0.5 shrink-0 text-[#d9c49e]"
                  size={18}
                />
              ...
              <p className="flex gap-3">
                <Phone
                  ...
                  size={18}
                />
                <a href="tel:5550169084" className="hover:text-white">
                  (555) 016-9084
                </a>
              </p>
            </div>
