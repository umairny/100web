...
const trustPoints = ['Easy online booking', 'Clear treatment guidance', 'Modern dental care']

const heroSlides = [
  {
    image: 'medical/northstar/hero.png',
  ...
  {
    image: 'medical/northstar/treatment-room.png',
  ...
  {
    image: 'medical/northstar/booking-flow.png',
...
const services: Array<{ title: string; text: string; icon: LucideIcon; image: string }> = [
  {
    ...
    icon: SmilePlus,
    image: 'medical/northstar/dental-checkup.png',
  },
  {
    title: 'Dental Cleanings',
    text: 'Professional cleaning appointments with simple guidance for ongoing home care.',
    icon: Sparkles,
    image: 'medical/northstar/cleaning-care.png',
  },
  {
    title: 'Cosmetic Dentistry',
    text: 'Consultation-focused conversations around appearance goals, options, and planning.',
    icon: SmilePlus,
    image: 'medical/northstar/cosmetic-dentistry.png',
  },
  {
    title: 'Emergency Dental Concerns',
    text: 'For urgent dental concerns, contact the office so the team can guide your next step.',
    icon: ShieldCheck,
    image: 'medical/northstar/emergency-dental.png',
  },
  {
    title: 'Family Dentistry',
    text: 'Organized care paths for adults, teens, and family appointment planning.',
    icon: Users,
    image: 'medical/northstar/family-dental.png',
  },
  {
    title: 'Treatment Planning',
    text: 'Plain-language planning that helps patients understand timing, priorities, and follow-up.',
    icon: ClipboardCheck,
    image: 'medical/northstar/patient-details.png',
  },
]

const visitDetails = [
  ['New patient forms', 'Complete basic information ahead of time so the first visit feels organized.'],
  ['What to bring', 'Bring ID, current health details, medication lists, and any dental questions.'],
  ['First visit expectations', 'The team reviews your visit reason, answers questions, and explains likely next steps.'],
  ['Payment and appointment questions', 'Contact the office for appointment options and payment questions before care begins.'],
  ['Follow-up planning', 'Patients leave with clear timing and practical next steps when follow-up is recommended.'],
  ['Urgent dental concerns', 'Contact the office for urgent dental concerns. For severe symptoms, contact emergency services or a licensed dental professional.'],
]
...
const environmentPoints = ['Modern treatment rooms', 'Clear explanations', 'Comfort-focused visits']

const appointmentTypes = ['Cleaning & exam', 'New patient visit', 'Cosmetic consultation', 'Dental concern', 'Follow-up visit']

const reviews = [
  {
    name: 'Leah',
    quote: 'The team explained each step clearly and made the appointment feel easy.',
  },
  {
    name: 'Omar',
    quote: 'Booking was straightforward, and I understood what to bring before I arrived.',
  },
  {
    name: 'Tessa',
    quote: 'The office felt modern and calm, and the visit details were easy to follow.',
  },
]
  ...
  return (
    <main className="brand-motion bg-[#f7fbfd] text-[#17253f]">
          ...
          <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-end">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <CTAButton href="#contact" size="lg" className="bg-[#9eeaf4] text-[#17253f] hover:bg-white">
                  Book Appointment
                </CTAButton>
                <CTAButton
                  href="#services"
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {trustPoints.map((point) => (
                  <div key={point} className="rounded-2xl bg-white/10 p-4 text-sm font-black text-white/84 ring-1 ring-white/14 backdrop-blur">
                    <CheckCircle aria-hidden="true" className="mb-2 text-[#9eeaf4]" size={19} />
                    {point}
                  </div>
                ))}
              </div>
            ...
            <div className="justify-self-end rounded-[1.5rem] border border-white/18 bg-white/12 p-4 shadow-2xl shadow-black/20 backdrop-blur md:w-[26rem]">
              <p className="text-xs font-black uppercase text-[#9eeaf4]">Next available</p>
              <p className="mt-2 text-2xl font-black leading-tight">Choose a visit type and send details ahead.</p>
              <div className="mt-5 grid gap-2 text-sm font-bold text-white/78">
                <span className="rounded-xl bg-white/12 px-3 py-2 ring-1 ring-white/12">Cleaning & exam</span>
                <span className="rounded-xl bg-white/12 px-3 py-2 ring-1 ring-white/12">Dental concern</span>
                <span className="rounded-xl bg-white/12 px-3 py-2 ring-1 ring-white/12">New patient visit</span>
              </div>
            </div>
          </div>
              ...
              {heroSlides.map((slide, index) => (
                <button
                  ...
                  className={`h-2.5 rounded-full transition-all ${
                    index === activeSlide ? 'w-12 bg-[#9eeaf4]' : 'w-2.5 bg-white/42 hover:bg-white/70'
                  }`}
                />
              ))}
            </div>
              ...
              {heroSlides.map((slide, index) => (
                <button
                  ...
                  className={`rounded-xl px-4 py-3 text-left transition ${
                    index === activeSlide ? 'bg-white text-[#17253f]' : 'bg-white/8 hover:bg-white/14'
                  }`}
                >
                  {slide.label}
                </button>
      ...
      <section id="booking" className="py-20 md:py-28">
        <Container>
          <div className="mb-12 max-w-3xl">
            <p className="text-sm font-black uppercase text-[#126f86]">Booking flow</p>
            <h2 className="mt-3 text-4xl font-black leading-tight text-[#17253f] md:text-5xl">A cleaner way to book dental care.</h2>
          </div>
          <div className="grid gap-5 lg:grid-cols-3">
            {bookingSteps.map(({ title, text, icon }, index) => (
              <article key={title} className="rounded-[1.5rem] border border-[#dbe9ef] bg-white p-6 shadow-sm shadow-[#17253f]/5">
                <div className="flex items-center justify-between gap-4">
                  <IconTile icon={icon} />
                  <span className="text-sm font-black text-[#9bb0bf]">0{index + 1}</span>
                </div>
                <h3 className="mt-7 text-2xl font-black text-[#17253f]">{title}</h3>
      ...
      <section id="services" className="bg-white py-20 md:py-28">
        <Container>
          <div className="mb-12 max-w-3xl">
            <p className="text-sm font-black uppercase text-[#126f86]">Services</p>
            <h2 className="mt-3 text-4xl font-black leading-tight text-[#17253f] md:text-5xl">Dental services with clear next steps.</h2>
          </div>
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {services.map(({ title, text, icon, image }) => (
              <article key={title} className="group overflow-hidden rounded-[1.5rem] border border-[#dbe9ef] bg-[#fbfdfe] shadow-sm shadow-[#17253f]/5">
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute left-4 top-4 rounded-2xl bg-white/92 p-2 text-[#126f86] shadow-lg shadow-[#17253f]/10">
                    {(() => {
                      const Icon = icon
                      return <Icon aria-hidden="true" size={22} strokeWidth={2} />
                    })()}
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-2xl font-black text-[#17253f]">{title}</h3>
                  <p className="mt-3 text-sm leading-7 text-[#5e6d7c]">{text}</p>
                </div>
              </article>
            ))}
      ...
      <section id="visit-info" className="py-20 md:py-28">
        <Container className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase text-[#126f86]">Visit info</p>
            <h2 className="mt-3 text-4xl font-black leading-tight text-[#17253f] md:text-5xl">Patient-first details before the appointment.</h2>
            <img
              src={imageUrl('medical/northstar/patient-details.png')}
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {visitDetails.map(([title, text]) => (
              <article key={title} className="rounded-[1.35rem] border border-[#dbe9ef] bg-white p-5 shadow-sm shadow-[#17253f]/5">
      ...
      <section id="dentists" className="bg-[#eefbfe] py-20 md:py-28">
        <Container>
          <div className="mb-12 grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            <div>
              <p className="text-sm font-black uppercase text-[#126f86]">Dentists</p>
              <h2 className="mt-3 text-4xl font-black leading-tight text-[#17253f] md:text-5xl">A dental team focused on comfort and clarity.</h2>
            </div>
            <p className="max-w-2xl text-lg leading-8 text-[#5e6d7c]">
              Provider introductions stay practical, credible, and focused on how patients are guided through care.
            </p>
          </div>
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="grid gap-5">
              {providers.map(({ name, role, bio }) => (
                <article key={name} className="rounded-[1.5rem] border border-[#cfe8ef] bg-white p-6 shadow-sm shadow-[#17253f]/5">
                  <h3 className="text-2xl font-black text-[#17253f]">{name}</h3>
                  <p className="mt-1 text-sm font-black text-[#126f86]">{role}</p>
      ...
      <section className="py-20 md:py-28">
        <Container className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <img
            src={imageUrl('medical/northstar/treatment-room.png')}
            alt="A clean modern dental treatment room"
            className="h-[34rem] w-full rounded-[1.75rem] object-cover shadow-xl shadow-[#17253f]/9"
          />
          <div>
            <p className="text-sm font-black uppercase text-[#126f86]">Environment</p>
            <h2 className="mt-3 text-4xl font-black leading-tight text-[#17253f] md:text-5xl">A clean, modern space for calmer visits.</h2>
            <p className="mt-5 text-lg leading-8 text-[#5e6d7c]">
              Designed with bright rooms, clear communication, and a calm patient experience in mind.
            </p>
            <div className="mt-8 grid gap-3">
              {environmentPoints.map((point) => (
                <div key={point} className="flex items-center gap-3 rounded-2xl border border-[#dbe9ef] bg-white p-4 shadow-sm shadow-[#17253f]/5">
                  <CheckCircle aria-hidden="true" className="text-[#1c9f9c]" size={20} />
      ...
      <section className="bg-[#17253f] py-20 text-white md:py-28">
        <Container className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase text-[#9eeaf4]">Appointment access</p>
            <h2 className="mt-3 text-4xl font-black leading-tight md:text-5xl">Book the right dental visit without the guesswork.</h2>
            <div className="mt-8">
              <CTAButton href="#contact" size="lg" className="bg-[#9eeaf4] text-[#17253f] hover:bg-white">
                Book Appointment
              </CTAButton>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {appointmentTypes.map((item) => (
              <div key={item} className="flex items-center gap-3 rounded-2xl bg-white/10 p-4 ring-1 ring-white/14">
                <CheckCircle aria-hidden="true" className="text-[#9eeaf4]" size={20} />
      ...
      <section id="reviews" className="py-20 md:py-28">
        <Container>
          <div className="mb-12 max-w-3xl">
            <p className="text-sm font-black uppercase text-[#126f86]">Reviews</p>
            <h2 className="mt-3 text-4xl font-black leading-tight text-[#17253f] md:text-5xl">Appointments that feel organized.</h2>
          </div>
          <div className="grid gap-5 md:grid-cols-3">
            {reviews.map(({ name, quote }) => (
              <blockquote key={name} className="rounded-[1.5rem] border border-[#dbe9ef] bg-white p-7 shadow-sm shadow-[#17253f]/5">
                <p className="text-5xl font-black leading-none text-[#9ccbd7]">&ldquo;</p>
                <p className="mt-2 text-lg font-bold leading-8 text-[#17253f]">{quote}</p>
                <footer className="mt-6 text-sm font-black uppercase text-[#126f86]">{name}</footer>
              </blockquote>
            ))}
          </div>
        </Container>
      ...
      <section id="contact" className="relative isolate overflow-hidden bg-[#17253f] py-20 text-white md:py-28">
        <img
          src={imageUrl('medical/northstar/cta.png')}
          alt=""
          aria-hidden="true"
        ...
        <Container className="max-w-5xl">
          <p className="text-sm font-black uppercase text-[#9eeaf4]">Start here</p>
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/76">
            Start with a simple appointment and get clear guidance from a dental team focused on comfort, organization,
            and practical next steps.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <CTAButton href="mailto:hello@northstar.example" size="lg" className="bg-[#9eeaf4] text-[#17253f] hover:bg-white">
              Book Appointment
            </CTAButton>
            <CTAButton
              href="tel:5550187442"
          ...
          <p className="mt-6 text-sm leading-6 text-white/68">
            For urgent or severe symptoms, contact appropriate emergency services or a licensed dental professional.
          </p>
        </Container>
      </section>
        ...
        <Container>
          <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr_1fr]">
            ...
            <nav aria-label="Footer navigation" className="grid gap-2 text-sm font-bold text-white/72">
              {['Services', 'Booking', 'Dentists', 'Visit Info', 'Reviews', 'Contact', 'Privacy'].map((item) => (
                <a
                  key={item}
                  href={item === 'Services' ? '#services' : item === 'Booking' ? '#booking' : item === 'Dentists' ? '#dentists' : item === 'Visit Info' ? '#visit-info' : item === 'Reviews' ? '#reviews' : '#contact'}
            ...
            <div className="grid gap-3 text-sm text-white/72">
              <p className="flex gap-3">
                <MapPin aria-hidden="true" className="mt-0.5 shrink-0 text-[#9eeaf4]" size={18} />
                <span>410 Northstar Avenue, Suite 300</span>
              </p>
              <p className="flex gap-3">
                <Clock aria-hidden="true" className="mt-0.5 shrink-0 text-[#9eeaf4]" size={18} />
                <span>Monday-Friday, 8 AM-6 PM</span>
              </p>
              <p className="flex gap-3">
                <Calendar aria-hidden="true" className="mt-0.5 shrink-0 text-[#9eeaf4]" size={18} />
                <span>Saturday, 9 AM-2 PM</span>
              </p>
              <p className="flex gap-3">
                <Phone aria-hidden="true" className="mt-0.5 shrink-0 text-[#9eeaf4]" size={18} />
                <a href="tel:5550187442" className="hover:text-white">(555) 018-7442</a>
              </p>
            </div>
          </div>
        </Container>
