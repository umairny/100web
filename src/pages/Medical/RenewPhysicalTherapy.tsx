...
const planSteps = [
  [
    ...
    "Your therapist evaluates movement, symptoms, strength, mobility, and everyday goals.",
  ],
  [
    "Build your plan",
    "You receive a practical recovery plan with exercises, therapy sessions, and follow-up goals.",
  ],
  [
    "Practice with support",
    "Your therapist guides your movements, adjusts your plan, and helps you build confidence.",
  ],
  [
    "Track progress",
    "Progress is reviewed through movement improvements, comfort, consistency, and daily function.",
  ],
];
...
const studioFeatures = [
  "Private evaluation space",
  "Guided exercise area",
  "Practical home-plan support",
];

const visitDetails = [
  [
    "What to bring",
    "Bring comfortable clothing, current movement questions, and any visit notes you want reviewed.",
  ],
  [
    "First evaluation",
    "Your therapist reviews movement, symptoms, goals, and practical next steps for care.",
  ],
  [
    "Follow-up visits",
    "Follow-ups may include guided practice, hands-on care, plan adjustments, and progress review.",
  ],
  [
    "Home exercises",
    "Your plan may include simple practice between visits with clear instructions.",
  ],
  [
    "Appointment timing",
    "Visit timing depends on evaluation needs, therapy focus, and follow-up goals.",
  ],
  [
...
const reviews = [
  {
    name: "Ari",
    quote:
      "They explained what we were working on and helped me understand what to practice between visits.",
  },
  {
    name: "Nora",
    quote:
      "The plan felt organized, and I could see what the next step was after each appointment.",
  },
  {
    name: "Ben",
    quote:
      "The studio felt calm and focused. The team made the exercises easy to follow.",
  },
];
...
export function RenewPhysicalTherapy() {
  return (
    <main className="brand-motion bg-[#f8f5ef] text-[#222b30]">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:items-end">
            <div>
              <p className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-black text-[#f0c9a7] ring-1 ring-white/16 backdrop-blur">
                <Activity aria-hidden="true" size={17} /> Recovery plans and
                progress proof
              </p>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/76 md:text-xl">
                Renew Physical Therapy helps patients understand what is
                limiting movement, follow a practical recovery plan, and track
                progress with a care team focused on steady improvement.
              </p>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <CTAButton
                  href="#contact"
                  size="lg"
                  className="bg-[#d96d5c] text-white hover:bg-[#f0c9a7] hover:text-[#171f23]"
                >
                  Book Evaluation
                </CTAButton>
                <CTAButton
            ...
            <div className="grid gap-4 sm:grid-cols-[0.72fr_1fr] lg:items-end">
              <div className="grid gap-4">
                {trustPoints.map((point) => (
                  <div
                    key={point}
                    className="rounded-[1.25rem] bg-white/10 p-4 text-sm font-black text-white/84 ring-1 ring-white/14 backdrop-blur"
                  >
                    <CheckCircle
                      aria-hidden="true"
                      className="mb-2 text-[#f0c9a7]"
                      size={19}
                    />
                    {point}
                  </div>
              ...
              <div className="rounded-[1.75rem] border border-white/16 bg-white/12 p-5 shadow-2xl shadow-black/18 backdrop-blur">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <p className="text-xs font-black uppercase text-[#f0c9a7]">
                      Progress plan
                    </p>
                    <p className="mt-1 text-2xl font-black leading-tight">
                      One plan, visible next steps.
                    </p>
                  </div>
                  <TrendingUp
                    aria-hidden="true"
                    className="shrink-0 text-[#d96d5c]"
                    size={30}
                  />
                </div>
                <div className="mt-5 grid gap-3">
                  {progressPlan.map((step, index) => (
                    <div
                      key={step}
                      className="grid grid-cols-[2.5rem_1fr] items-center gap-3 rounded-2xl bg-white/10 p-3 ring-1 ring-white/12"
                    >
      ...
      <section
        id="services"
        className="overflow-hidden bg-[#efe8dc] py-20 md:py-28"
      >
        <Container>
          <div className="mb-12 grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            <div>
              <p className="text-sm font-black uppercase text-[#507566]">
                Services
              </p>
            ...
            <p className="max-w-3xl text-lg leading-8 text-[#5d6667]">
              Services are grouped like a working therapy floor: assess the
              movement, practice the right skill, and review the plan before the
              next visit.
            </p>
          </div>
          ...
          <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="relative min-h-[38rem] overflow-hidden rounded-[2rem] bg-[#222b30] shadow-2xl shadow-[#222b30]/12">
              <img
                src={imageUrl("medical/renewphysical/therapy.webp")}
              ...
              <div className="absolute left-5 right-5 top-5 grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={label}
                    className="rounded-2xl bg-white/12 p-4 text-white ring-1 ring-white/14 backdrop-blur"
                  >
                    <p className="text-xs font-black uppercase text-[#f0c9a7]">
                      {label}
                    </p>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white md:p-8">
                <p className="text-sm font-black uppercase text-[#f0c9a7]">
                  Therapy service lab
                </p>
                ...
                <p className="mt-4 max-w-2xl text-sm leading-7 text-white/72">
                  Renew keeps services connected to a practical recovery plan so
                  each visit has a purpose and a next step.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-4">
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ["Rehab practice", "medical/renewphysical/rehab.webp"],
                  ["Movement work", "medical/renewphysical/movement.webp"],
                ].map(([label, image]) => (
                  <div
                    key={label}
                    className="relative h-48 overflow-hidden rounded-[1.5rem] shadow-sm shadow-[#222b30]/7"
                  >
                    <img
                      src={imageUrl(image)}
                      alt=""
                    ...
                    <p className="absolute bottom-4 left-4 text-sm font-black uppercase text-white">
                      {label}
                    </p>
                  </div>
                ))}
                ...
                {services.map(({ title, text, icon }, index) => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <span className="mt-1 text-xs font-black text-[#d96d5c]">
                        0{index + 1}
                      </span>
                      <IconTile icon={icon} />
                      <div>
                        <h3 className="text-xl font-black text-[#222b30]">
                          {title}
                        </h3>
                        <p className="mt-2 text-sm leading-6 text-[#5d6667]">
                          {text}
                        </p>
                        <a
                          href="#contact"
                          className="mt-3 inline-flex items-center gap-2 text-sm font-black text-[#507566] hover:text-[#222b30]"
                        >
        ...
        <Container>
          <div className="mb-12 grid gap-6 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            ...
            <p className="max-w-3xl text-lg leading-8 text-white/70">
              A structured board pairs therapy steps with simple progress
              signals, so the visit feels active, organized, and easy to follow
              without making medical promises.
            </p>
          </div>
          ...
          <div className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="grid gap-5">
              <img
                src={imageUrl("medical/renewphysical/recovery.webp")}
                alt="Guided therapy movement practice"
                className="h-72 w-full rounded-[1.75rem] object-cover shadow-xl shadow-black/20"
              />
              <div
                id="progress"
                className="rounded-[1.75rem] bg-white p-5 text-[#222b30] shadow-xl shadow-black/18"
              >
                <div className="mb-5 flex items-center justify-between gap-4">
                  <div>
                    <p className="text-xs font-black uppercase text-[#507566]">
                  ...
                  {progressCards.map(([title, value, width]) => (
                    <div key={title}>
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <p className="text-sm font-black text-[#507566]">
                          {value}
                        </p>
                      </div>
                      <div className="mt-2 h-2 overflow-hidden rounded-full bg-[#e7ded0]">
                        <div
                          className={`h-full rounded-full bg-[#d96d5c] ${width}`}
                        />
                      </div>
                    </div>
                  ))}
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-[#5d6667]">
                These are starting points for a conversation with a therapist,
                not diagnoses or promised outcomes.
              </p>
              <div className="mt-8 grid gap-3">
                {visitReasons.map((reason, index) => (
                  <article
                    key={reason}
                    className="grid grid-cols-[3rem_1fr] items-center gap-4 rounded-2xl bg-white p-4 ring-1 ring-[#e7ded0]"
                  >
                    <span className="text-sm font-black text-[#d96d5c]">
                      0{index + 1}
                    </span>
            ...
            <div className="relative">
              <img
                src={imageUrl("medical/renewphysical/progress-tracking.webp")}
              ...
              <div className="absolute bottom-5 left-5 right-5 rounded-[1.35rem] bg-[#222b30]/92 p-5 text-white shadow-xl shadow-black/18 backdrop-blur">
                ...
                <p className="mt-2 text-lg font-bold leading-7">
                  The goal is to understand movement needs and choose practical
                  next steps with a licensed care team.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="therapists" className="bg-[#f8f5ef] py-20 md:py-28">
        <Container>
          <div className="mb-12 grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            ...
            <p className="max-w-3xl text-lg leading-8 text-[#5d6667]">
              Provider introductions stay focused on how the team supports
              movement, practice, and follow-through.
            </p>
          </div>
          <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
            <img
              src={imageUrl("medical/renewphysical/team.webp")}
            ...
            <div className="grid gap-0 overflow-hidden rounded-[2rem] border border-[#e7ded0] bg-white shadow-sm shadow-[#222b30]/5">
              {providers.map(({ name, role, bio }) => (
                <article
                  key={name}
                  className="border-b border-[#e7ded0] p-6 last:border-b-0"
                >
                  <h3 className="text-2xl font-black">{name}</h3>
                  <p className="mt-1 text-sm font-black text-[#507566]">
                    {role}
                  </p>
      ...
      <section className="bg-[#eef5f1] py-20 md:py-28">
        <Container className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <img
            src={imageUrl("medical/renewphysical/therapy-studio.webp")}
          ...
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-[#5d6667]">
              A clean, supportive space for assessments, guided movement,
              hands-on care, and practical recovery work.
            </p>
            <div className="mt-8 grid gap-3">
              {studioFeatures.map((feature) => (
                <div
                  key={feature}
                  className="flex items-center gap-3 rounded-2xl bg-white p-4 ring-1 ring-[#d6e2dc]"
                >
                  <CheckCircle
                    aria-hidden="true"
                    className="text-[#507566]"
                    size={20}
                  />
        ...
        <Container>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {visitDetails.map(([title, text]) => (
              <article
                key={title}
                className="rounded-[1.35rem] border border-[#e7ded0] bg-white p-5 shadow-sm shadow-[#222b30]/5"
              >
                <FileText
                  aria-hidden="true"
                  className="text-[#507566]"
          ...
          <div>
            ...
            <div className="mt-8">
              <CTAButton
                href="#contact"
                size="lg"
                className="bg-[#d96d5c] text-white hover:bg-[#f0c9a7] hover:text-[#222b30]"
              >
                Book Evaluation
              </CTAButton>
            </div>
      ...
      <section id="reviews" className="py-20 md:py-28">
        <Container>
          <div className="mb-12 grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            ...
            <img
              src={imageUrl("medical/renewphysical/appointment.webp")}
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {reviews.map(({ name, quote }) => (
              <blockquote
                key={name}
                className="rounded-[1.5rem] border border-[#e7ded0] bg-white p-7 shadow-sm shadow-[#222b30]/5"
              >
                <p className="text-5xl font-black leading-none text-[#d96d5c]">
                  &ldquo;
                </p>
                <p className="mt-2 text-lg font-bold leading-8">{quote}</p>
                <footer className="mt-6 text-sm font-black uppercase text-[#507566]">
                  {name}
                </footer>
              </blockquote>
            ))}
      ...
      <section
        id="contact"
        className="relative isolate overflow-hidden bg-[#222b30] py-20 text-white md:py-28"
      >
        <img
          src={imageUrl("medical/renewphysical/cta.webp")}
          alt=""
          aria-hidden="true"
        ...
        <Container className="max-w-5xl">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/76">
            Book an evaluation and leave with clear next steps, practical
            guidance, and a therapy plan built around your goals and daily
            movement.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <CTAButton
              href="mailto:hello@renewpt.example"
              size="lg"
              className="bg-[#d96d5c] text-white hover:bg-[#f0c9a7] hover:text-[#222b30]"
            >
              Book Evaluation
          ...
          <p className="mt-6 text-sm leading-6 text-white/68">
            For urgent or severe symptoms, contact a licensed healthcare
          ...
          <div className="grid gap-8 md:grid-cols-[1.15fr_0.85fr_1fr]">
            <div>
              ...
              <p className="mt-3 max-w-md leading-7 text-white/68">
                Recovery plans and progress proof for patient-first movement
                care.
              </p>
            </div>
            <nav
            ...
            <div className="grid gap-3 text-sm text-white/72">
              <p className="flex gap-3">
                <MapPin
                  aria-hidden="true"
                  className="mt-0.5 shrink-0 text-[#f0c9a7]"
                  size={18}
                />
              ...
              <p className="flex gap-3">
                <Phone
                  ...
                  size={18}
                />
                <a href="tel:5550174826" className="hover:text-white">
                  (555) 017-4826
                </a>
              </p>
            </div>
