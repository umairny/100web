...
import heroImage from "../../assets/optimized/realestate/apex/hero.webp";
import officeImage from "../../assets/optimized/realestate/apex/office-brokerage.webp";
import retailImage from "../../assets/optimized/realestate/apex/retail-leasing.webp";
import investmentImage from "../../assets/optimized/realestate/apex/investment-sales.webp";
import bayfrontImage from "../../assets/optimized/realestate/apex/bayfront-office-tower.webp";
import harborRetailImage from "../../assets/optimized/realestate/apex/harbor-retail-plaza.webp";
import meridianImage from "../../assets/optimized/realestate/apex/meridian-mixed-use.webp";
import intelligenceImage from "../../assets/optimized/realestate/apex/market-intelligence.webp";
import waterfrontImage from "../../assets/optimized/realestate/apex/waterfront-mixed-use.webp";
import hospitalityImage from "../../assets/optimized/realestate/apex/boutique-hospitality.webp";
import coastalRetailImage from "../../assets/optimized/realestate/apex/coastal-retail.webp";
import ctaImage from "../../assets/optimized/realestate/apex/cta-commercial-building.webp";
...
const categories = [
  {
    image: officeImage,
    label: "01 / Office",
    title: "Office Brokerage",
    text: "Modern workspace acquisition, leasing, and tenant strategy for growing companies.",
  },
  {
    image: retailImage,
    label: "02 / Retail",
    title: "Retail Leasing",
    text: "High-visibility retail locations matched with market demand and long-term value.",
  },
  {
    image: investmentImage,
    label: "03 / Investment",
    title: "Investment Sales",
    text: "Data-led commercial opportunities designed for stable returns and portfolio growth.",
  },
];
...
const opportunities = [
  {
    image: bayfrontImage,
    tag: "Office",
    title: "Bayfront Office Tower",
    location: "Coastal Business District",
    type: "Office / Leasing",
    size: "86,000 sq ft",
  },
  {
    image: harborRetailImage,
    tag: "Retail",
    title: "Harbor Retail Plaza",
    location: "Waterfront Retail Corridor",
  ...
  },
  {
    image: meridianImage,
    tag: "Mixed-Use",
    title: "Meridian Mixed-Use Asset",
    location: "Urban Coastal Core",
    type: "Mixed-Use / Sale",
    size: "118,000 sq ft",
  },
];
...
const services = [
  {
    ...
    text: "Site strategy, market comparisons, and lease terms aligned with operating goals.",
  },
  {
    icon: Building2,
    title: "Landlord Representation",
    text: "Positioning and leasing programs designed to strengthen occupancy and asset value.",
  },
  {
    icon: KeyRound,
    title: "Commercial Leasing",
    text: "Disciplined advisory across office, retail, and mixed-use lease transactions.",
  },
  {
    icon: Landmark,
    title: "Investment Sales",
    text: "Acquisition and disposition strategy grounded in asset performance and demand.",
  },
  {
    icon: Scale,
    title: "Property Valuation",
    text: "Clear, defensible opinions of value informed by current market evidence.",
  },
  {
    icon: BarChart3,
    title: "Market Research",
    text: "Actionable intelligence on rents, absorption, comparables, and capital trends.",
  },
];
...
const values = [
  {
    ...
    text: "The information you need to compare risk, timing, and opportunity.",
  },
  {
    number: "02",
    title: "Negotiation Strength",
    text: "Experienced representation at every material point in the transaction.",
  },
  {
    number: "03",
    title: "Asset Strategy",
    text: "Advice shaped around performance, positioning, and long-term business goals.",
  },
  {
    number: "04",
    title: "Investor Confidence",
    text: "A deliberate process that turns complex information into decisive action.",
  },
];
...
function ApexMark({ light = false }: { light?: boolean }) {
  return (
    ...
    >
      ...
      <span>
        <span className="block text-sm font-black uppercase leading-none tracking-[0.14em]">
          Apex Commercial
        </span>
        <span
...
function ApexButton({
  ...
  return (
    <a
      href={href}
      className={`group inline-flex min-h-12 items-center justify-center gap-3 px-6 text-xs font-bold uppercase tracking-[0.13em] transition-all duration-300 hover:-translate-y-0.5 ${styles[variant]}`}
    >
      {children}
...
export function ApexCommercialRealty() {
  ...
  return (
    <main className="apex-site overflow-hidden bg-[#F4F6F8] text-[#1C2736]">
      ...
      <section
        id="home"
        className="relative min-h-[850px] pt-20 lg:min-h-[930px]"
      >
        <div className="absolute inset-0 top-20">
          <img
            src={heroImage}
            alt="Premium coastal commercial property"
        ...
        <div className="relative mx-auto flex min-h-[770px] max-w-[92rem] items-center px-5 py-20 sm:px-8 lg:min-h-[850px] lg:px-12">
          <div className="max-w-4xl text-[#F4F6F8]">
            ...
            <h1 className="apex-serif max-w-4xl text-[clamp(3.7rem,7.2vw,7.3rem)] leading-[0.9] tracking-[-0.045em]">
              Commercial Real Estate Built Around{" "}
              <em className="font-normal text-[#F4F6F8]">
                Market Intelligence
              </em>
            </h1>
            <p className="mt-8 max-w-2xl text-base leading-8 text-white/70 md:text-lg">
              Apex Commercial Realty connects investors, tenants, landlords, and
              developers with strategic office, retail, leasing, and coastal
              commercial property opportunities.
            </p>
            <div className="mt-10 flex flex-wrap gap-3">
              <ApexButton href="#properties">Explore Properties</ApexButton>
              <ApexButton href="#contact" variant="outline">
          ...
          <div className="absolute bottom-0 right-0 hidden bg-[#1C2736]/95 lg:grid lg:grid-cols-3">
            {[
              ...
              <div
                key={label}
                className="min-w-[180px] border-l border-white/10 px-7 py-6"
              >
                <p className="apex-serif text-3xl text-[#F4F6F8]">{value}</p>
                <p className="mt-2 text-[0.58rem] font-bold uppercase tracking-[0.2em] text-[#F4F6F8]/60">
                  {label}
                </p>
              </div>
            ))}
      ...
      <section className="px-5 py-24 sm:px-8 md:py-32 lg:px-12">
        <div className="mx-auto max-w-[88rem]">
          <SectionTitle
            ...
            title="Commercial Strategy Across Every Asset Class"
            body="Focused advisory for businesses, owners, and capital partners navigating complex commercial decisions."
          />
          <div className="mt-14 grid gap-6 lg:grid-cols-3">
            {categories.map((category, index) => (
              ...
              >
                <div className="aspect-[1.32] overflow-hidden">
                  <img
                    src={category.image}
                    alt={category.title}
        ...
        <div className="mx-auto max-w-[92rem]">
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <SectionTitle
              ...
              title="Featured Commercial Assets"
              body="Select opportunities positioned for occupancy, income performance, and long-term value."
            />
            <a
              href="#contact"
        ...
        <div className="grid lg:grid-cols-2">
          <div className="min-h-[520px] lg:min-h-[720px]" data-apex-reveal>
            <img
              ...
              alt="Commercial market intelligence and analysis"
              className="h-full w-full object-cover"
            />
          </div>
          <div
          ...
          >
            <div className="max-w-xl">
              <SectionTitle
                ...
                title="Insight-Driven Commercial Decisions"
                body="From leasing trends to investment performance, our advisory process is built around clear market intelligence, asset positioning, and long-term value creation."
                light
              />
              <div className="mt-10 grid gap-1">
                {[
                  ...
                  "Leasing and investment strategy",
                ].map((item, index) => (
                  <div
                    key={item}
      ...
      <section className="border-y border-[#1C2736]/15 bg-[#1C2736]/[0.06] px-5 py-24 sm:px-8 md:py-32 lg:px-12">
        <div className="mx-auto max-w-[88rem]">
          <SectionTitle
            label="Why Apex"
            title="Structured Advisory for Complex Commercial Moves"
            centered
          />
        ...
        <div className="mx-auto max-w-[92rem]">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {coastalAssets.map((asset, index) => (
              <article
                key={asset.title}
                className={`group relative overflow-hidden ${index === 1 ? "md:mt-12" : ""}`}
                data-apex-reveal
              >
      ...
      <section
        id="contact"
        className="relative px-5 py-28 text-[#F4F6F8] sm:px-8 md:py-40 lg:px-12"
      >
        <div className="absolute inset-0">
          <img
            src={ctaImage}
            alt="Coastal commercial building at dusk"
            className="h-full w-full object-cover"
          />
        ...
        <div className="relative mx-auto max-w-[88rem]" data-apex-reveal>
          ...
          <h2 className="apex-serif mt-6 max-w-4xl text-[clamp(3rem,6vw,6rem)] leading-[0.95] tracking-[-0.04em]">
            Ready to Evaluate Your Next Commercial Opportunity?
          </h2>
          <p className="mt-7 max-w-2xl text-base leading-8 text-white/65 md:text-lg">
            Connect with Apex Commercial Realty for strategic guidance on
            leasing, acquisition, disposition, and investment planning.
          </p>
          <div className="mt-10">
            <ApexButton href="mailto:info@apexcommercialrealty.com">
      ...
      <footer className="bg-[#101722] px-5 py-14 text-[#F4F6F8] sm:px-8 lg:px-12">
        <div className="mx-auto max-w-[88rem]">
          <div className="grid gap-12 border-b border-white/10 pb-12 md:grid-cols-[1.2fr_0.7fr_0.8fr_1fr]">
            <div>
              <ApexMark light />
              <p className="mt-6 max-w-sm text-sm leading-7 text-[#F4F6F8]/60">
                Commercial property brokerage and investment advisory built on
                market intelligence, disciplined execution, and lasting value.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="mt-5 grid gap-3 text-sm text-white/55">
                <span>Tenant Advisory</span>
                <span>Leasing Strategy</span>
          ...
          <div className="flex flex-col gap-3 pt-7 text-[0.65rem] uppercase tracking-[0.1em] text-white/30 sm:flex-row sm:justify-between">
            <p>© 2026 Apex Commercial Realty</p>
            <p>Commercial brokerage · Advisory · Investment sales</p>
          </div>
        </div>
      </footer>
    </main>
