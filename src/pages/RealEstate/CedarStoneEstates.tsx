...
import heroImage from "../../assets/optimized/realestate/cedar-stone/hero.webp";
import privateEstatesImage from "../../assets/optimized/realestate/cedar-stone/private-estates.webp";
import luxuryAcreageImage from "../../assets/optimized/realestate/cedar-stone/luxury-acreage.webp";
import heritageImage from "../../assets/optimized/realestate/cedar-stone/heritage-craftsmanship.webp";
import willowImage from "../../assets/optimized/realestate/cedar-stone/willow-ridge-estate.webp";
import stonehavenImage from "../../assets/optimized/realestate/cedar-stone/stonehaven-acreage.webp";
import cedarHollowImage from "../../assets/optimized/realestate/cedar-stone/cedar-hollow-residence.webp";
import craftsmanshipImage from "../../assets/optimized/realestate/cedar-stone/crafted-privacy.webp";
import lifestyleImage from "../../assets/optimized/realestate/cedar-stone/rural-lifestyle.webp";
import estateGroundsImage from "../../assets/optimized/realestate/cedar-stone/estate-grounds.webp";
import equestrianImage from "../../assets/optimized/realestate/cedar-stone/equestrian-living.webp";
import retreatImage from "../../assets/optimized/realestate/cedar-stone/private-retreat.webp";
import ctaImage from "../../assets/optimized/realestate/cedar-stone/cta-cedar-estate.webp";
...
const focusCards = [
  {
    image: privateEstatesImage,
    badge: "Estate Home",
    title: "Private Estates",
    text: "Residences positioned for quiet living, refined architecture, and a strong sense of place.",
    href: "#estates",
  },
  {
    image: luxuryAcreageImage,
    badge: "Acreage",
    title: "Luxury Acreage",
    text: "Expansive land-rich properties offering privacy, flexibility, and enduring value.",
    href: "#acreage",
  },
  {
    image: heritageImage,
    ...
    text: "Homes with timeless materials, careful detailing, and a deep connection to land and legacy.",
    href: "#craftsmanship",
  },
];
...
const properties = [
  {
    image: willowImage,
    badge: "Estate Home",
    title: "Willow Ridge Estate",
    location: "Countryside Reserve",
    type: "Estate Home",
    size: "8.4 Acres",
  },
  {
    image: stonehavenImage,
    badge: "Acreage",
    title: "Stonehaven Acreage",
    location: "Private Valley Enclave",
    type: "Luxury Acreage",
    size: "15.2 Acres",
  },
  {
    image: cedarHollowImage,
    badge: "Private Retreat",
    title: "Cedar Hollow Residence",
    location: "Heritage Hills",
    type: "Rural Luxury Home",
    size: "6.1 Acres",
  },
];
...
const values = [
  [
    "01",
    "Private Positioning",
    "Discreet representation shaped around the character of each property.",
  ],
  [
    "02",
    "Refined Presentation",
    "Editorial storytelling that gives architecture and landscape room to speak.",
  ],
  [
    "03",
    "Heritage Perspective",
    "An appreciation for material integrity, provenance, and sense of place.",
  ],
  [
    "04",
    "Long-Term Value",
    "Clear guidance grounded in land, stewardship, and enduring quality.",
  ],
];
...
const journal = [
  [
    "Estate Notes",
    "How to Evaluate a Luxury Rural Estate",
    "Consider the relationship between residence, land, access, infrastructure, and the life the property can support.",
  ],
  [
    "Land & Value",
    "What Defines Lasting Value in Acreage Properties",
    "A thoughtful look at usable land, setting, stewardship, improvements, and long-term flexibility.",
  ],
  [
    "Heritage Living",
    "Privacy, Craftsmanship, and the Appeal of Legacy Homes",
    "Why honest materials, considered details, and a settled landscape continue to carry meaning.",
  ],
];
...
function CedarLogo({ light = false }: { light?: boolean }) {
  return (
    ...
    >
      ...
      <span>
        <strong className="cedar-serif block text-[1.18rem] font-normal leading-none tracking-[0.01em]">
          Cedar & Stone
        </strong>
        <span
...
function CedarButton({
  ...
  return (
    <a
      href={href}
      className={`group inline-flex min-h-12 items-center justify-center gap-3 px-6 text-[0.68rem] font-bold uppercase tracking-[0.16em] transition duration-300 hover:-translate-y-0.5 ${styles[variant]}`}
    >
      {children}
...
export function CedarStoneEstates() {
  ...
  return (
    <main className="cedar-site overflow-hidden bg-[#E9E4D8] text-[#2E3A35]">
      ...
      <section
        id="home"
        className="relative min-h-[900px] pt-20 lg:min-h-[960px]"
      >
        <div className="absolute inset-0 top-20">
          <img
            src={heroImage}
            alt="Sweeping rural estate surrounded by mature trees and open land"
            className="h-full w-full object-cover"
          />
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(31,45,40,0.92)_0%,rgba(31,45,40,0.64)_48%,rgba(31,45,40,0.12)_82%)]" />
        </div>
        <div className="relative mx-auto flex min-h-[820px] max-w-[92rem] items-center px-5 py-20 sm:px-8 lg:min-h-[880px] lg:px-12">
          <div className="max-w-5xl text-[#E9E4D8]" data-cedar-reveal>
            ...
            <p className="mt-8 max-w-2xl text-base leading-8 text-white/68 md:text-lg">
              ...
              acreage properties defined by privacy, heritage-inspired design,
              and enduring craftsmanship.
            </p>
            <div className="mt-10 flex flex-wrap gap-3">
              <CedarButton href="#estates">Explore Estates</CedarButton>
              <CedarButton href="#acreage" variant="outline">
                Discover Acreage
              </CedarButton>
            </div>
          </div>
        ...
        <div className="absolute bottom-0 right-0 hidden bg-[#E9E4D8]/95 lg:grid lg:grid-cols-3">
          {[
            ...
            [Fence, "Heritage", "Craftsmanship"],
          ].map(([Icon, top, bottom]) => {
            const InfoIcon = Icon as typeof KeyRound;
            return (
              <div
                key={String(bottom)}
      ...
      <section className="px-5 py-24 sm:px-8 md:py-32 lg:px-12">
        <div className="mx-auto max-w-[88rem]">
          <SectionHeading
            eyebrow="Our focus"
            title="A Distinct Approach to Rural Luxury"
            text="A considered collection shaped by architecture, acreage, and the quiet qualities that make a property enduring."
            centered
          />
        ...
        <div className="mx-auto max-w-[92rem]">
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <SectionHeading
              ...
              text="A considered selection of residences and acreage distinguished by setting, privacy, and material character."
            />
            <a
              href="#contact"
        ...
        <div className="grid lg:grid-cols-2">
          <div className="min-h-[560px] lg:min-h-[760px]" data-cedar-reveal>
            <img
              ...
              alt="Natural stone and timber craftsmanship in a rural estate"
              className="h-full w-full object-cover"
            />
          </div>
          <div
          ...
          >
            <div>
              <SectionHeading
                ...
                title="Crafted for Privacy, Built to Endure"
                text="Our approach highlights homes where natural materials, thoughtful architecture, and enduring workmanship come together to create exceptional rural living."
                light
              />
              <div className="mt-10 grid">
                {[
                  [Leaf, "Timeless natural materials"],
                  [Home, "Thoughtful estate design"],
                  [ShieldCheck, "Lasting long-term value"],
                ].map(([Icon, text], index) => {
        ...
        <div className="mx-auto max-w-[90rem]">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            <SectionHeading
              ...
              title="The Rural Luxury Lifestyle"
              text="From quiet mornings and expansive grounds to private retreats and legacy properties, Cedar & Stone Estates represents a slower, more intentional standard of living."
            />
            <div className="overflow-hidden" data-cedar-reveal>
              <img
                src={lifestyleImage}
                alt="An unhurried rural lifestyle surrounded by open landscape"
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              const LifeIcon = Icon as typeof Compass;
              return (
                <article
                  key={String(title)}
      ...
      >
        ...
        <div className="relative mx-auto max-w-[92rem]">
          <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <SectionHeading
              eyebrow="Land-led living"
              title="Luxury Acreage with Room to Breathe"
              light
            />
            <div className="lg:pb-2" data-cedar-reveal>
              <p className="max-w-xl text-base leading-8 text-white/65 md:text-lg">
                More than scale, acreage creates a measured sense of
                arrival—space for privacy, stewardship, and a life shaped by the
                landscape.
              </p>
              <div className="mt-8 grid grid-cols-3 border-y border-white/12 py-5">
                {[
                  ...
                  <div
                    key={value}
                    className="border-r border-white/12 px-4 first:pl-0 last:border-r-0"
                  >
          ...
          <div className="mt-14 grid gap-5 lg:grid-cols-2 lg:grid-rows-2">
            {[
              [
                ...
                "Open lawns, mature trees, and a landscape that gives the residence its sense of place.",
              ],
              [
                equestrianImage,
                "Land-Rich Living",
                "Equestrian & Land-Rich Living",
                "Purposeful acreage with the flexibility to support horses, outbuildings, and considered country living.",
              ],
              [
                retreatImage,
                "Private Retreat",
                "Private Retreat Properties",
                "Secluded settings where distance, views, and quiet become part of the everyday experience.",
              ],
            ].map(([image, label, title, description], index) => (
              <article
                key={title}
                className={`group relative min-h-[320px] overflow-hidden border border-white/10 ${index === 0 ? "lg:row-span-2 lg:min-h-[680px]" : ""}`}
                data-cedar-reveal
                style={{ transitionDelay: `${index * 70}ms` }}
              >
                <img
                ...
                <div className="absolute inset-x-0 bottom-0 p-7 sm:p-8">
                  ...
                  <h3
                    className={`cedar-serif mt-3 leading-none ${index === 0 ? "text-4xl sm:text-5xl" : "text-3xl"}`}
                  >
                    {title}
                  </h3>
      ...
      <section className="bg-[#F4F1EA] px-5 py-24 sm:px-8 md:py-32 lg:px-12">
        <div className="mx-auto max-w-[88rem]">
          <SectionHeading
            eyebrow="Journal"
            title="Refined Living, Thoughtfully Presented"
            text="Notes on rural property, enduring materials, and the quieter considerations behind a meaningful estate."
          />
      ...
      <section
        id="contact"
        className="relative px-5 py-28 text-[#E9E4D8] sm:px-8 md:py-40 lg:px-12"
      >
        <div className="absolute inset-0">
          <img
            src={ctaImage}
            alt="Private cedar estate at the edge of a quiet landscape"
            className="h-full w-full object-cover"
          />
        ...
        <div className="relative mx-auto max-w-[88rem]" data-cedar-reveal>
          ...
          <h2 className="cedar-serif mt-6 max-w-4xl text-[clamp(3.2rem,6.5vw,6.5rem)] font-normal leading-[0.92] tracking-[-0.04em]">
            Discover a More Private Way to Live
          </h2>
          <p className="mt-7 max-w-2xl text-base leading-8 text-white/65 md:text-lg">
            Connect with Cedar & Stone Estates to explore luxury rural homes and
            acreage properties shaped by beauty, privacy, and lasting value.
          </p>
          <div className="mt-10">
            <CedarButton
      ...
      <footer className="bg-[#17231f] px-5 py-14 text-[#E9E4D8] sm:px-8 lg:px-12">
        <div className="mx-auto max-w-[88rem]">
          <div className="grid gap-12 border-b border-white/10 pb-12 md:grid-cols-[1.3fr_0.7fr_0.8fr_1fr]">
            <div>
              ...
              <p className="mt-6 max-w-sm text-sm leading-7 text-white/48">
                Rural estates and luxury acreage positioned through privacy,
          ...
          <div className="flex flex-col gap-3 pt-7 text-[0.62rem] uppercase tracking-[0.12em] text-white/28 sm:flex-row sm:justify-between">
            <p>© 2026 Cedar & Stone Estates</p>
            <p>Private estates · Luxury acreage · Heritage homes</p>
          </div>
        </div>
      </footer>
    </main>
