...
function FoundryButton({
  ...
  return (
    <a
      href={href}
      className={`group inline-flex min-h-12 items-center justify-center gap-3 px-6 text-[0.7rem] font-black uppercase tracking-[0.16em] transition duration-300 hover:-translate-y-0.5 ${outline ? "border border-current bg-transparent" : "bg-[#E86F2A] text-white hover:bg-[#cf5b1d]"} ${className}`}
    >
      {children}
...
function FoundryHeading({
  ...
  return (
    ...
    >
      <p className="flex items-center gap-3 text-[0.64rem] font-black uppercase tracking-[0.28em] text-[#E86F2A] before:h-px before:w-8 before:bg-[#E86F2A]">
        {eyebrow}
      </p>
      <h2
        className={`mt-5 text-[clamp(2.6rem,5.8vw,5.8rem)] font-black uppercase leading-[0.88] tracking-[-0.065em] ${light ? "text-white" : "text-[#242A32]"}`}
      >
        {title}
      </h2>
      {text && (
        <p
          className={`mt-6 max-w-2xl text-base leading-8 md:text-lg ${center ? "mx-auto" : ""} ${light ? "text-white/58" : "text-[#65707D]"}`}
        >
          {text}
        </p>
      )}
...
function FoundryMark({ light = false }: { light?: boolean }) {
  return (
    <a
      ...
      className={`flex items-center gap-3 ${light ? "text-white" : "text-[#10141A]"}`}
    >
      <span className="relative grid h-10 w-10 place-items-center border-2 border-[#E86F2A]">
        <Factory className="h-5 w-5" />
        <span className="absolute -bottom-1 -right-1 h-2.5 w-2.5 bg-[#E86F2A]" />
      </span>
      <span>
        ...
        <span
          className={`mt-1 block text-[0.52rem] font-bold uppercase tracking-[0.24em] ${light ? "text-white/55" : "text-[#65707D]"}`}
        >
          Property Group
        </span>
      </span>
...
export function FoundryPropertyGroup() {
  ...
  return (
    <main className="foundry-site overflow-hidden bg-[#F2F0EA] text-[#242A32] selection:bg-[#E86F2A] selection:text-white">
          ...
          >
            {navLinks.map(([label, href]) => (
              <a
                key={label}
                href={href}
                className="text-[0.66rem] font-black uppercase tracking-[0.16em] text-white/60 transition hover:text-white"
              >
                {label}
              </a>
            ))}
      ...
      <section
        id="home"
        className="relative min-h-[58rem] bg-[#10141A] pt-[4.5rem] text-white"
      >
        <img
          src={heroImage}
        ...
        <div className="relative mx-auto flex min-h-[53.5rem] max-w-[94rem] flex-col justify-between px-5 py-16 lg:px-10 lg:py-20">
          <div className="max-w-5xl">
            <p className="flex items-center gap-4 text-[0.65rem] font-black uppercase tracking-[0.3em] text-[#E86F2A] before:h-px before:w-12 before:bg-[#E86F2A]">
            ...
            <h1 className="mt-7 max-w-5xl text-[clamp(3.4rem,7.7vw,8.5rem)] font-black uppercase leading-[0.82] tracking-[-0.075em]">
              ...
              <span className="text-[#E86F2A]">for the Next Generation</span> of
              City Living
            </h1>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              <FoundryButton
                href="#investors"
                outline
                className="border-white/40 text-white hover:border-[#E86F2A] hover:text-[#E86F2A]"
              >
          ...
          <div className="mt-16 grid border-l border-t border-white/20 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={label}
                className="border-b border-r border-white/20 bg-[#10141A]/75 p-6 backdrop-blur-md"
              >
                <p className="text-4xl font-black tracking-[-0.06em] text-[#E86F2A] md:text-5xl">
                  {value}
                </p>
      ...
      <section className="px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-[94rem]">
          ...
          />
          <div className="mt-14 grid gap-px bg-[#C8CDD2] lg:grid-cols-3">
            {focusAreas.map((area) => (
              <article key={area.title} className="group bg-[#F2F0EA] p-4">
                <div className="relative aspect-[4/3] overflow-hidden bg-[#343A43]">
                  <img
                    src={area.image}
                    alt=""
                    className="h-full w-full object-cover grayscale-[20%] transition duration-700 group-hover:scale-105 group-hover:grayscale-0"
                  />
                  <span className="absolute left-0 top-0 bg-[#E86F2A] px-4 py-3 text-xs font-black text-white">
                    {area.number}
                  </span>
                </div>
                <div className="px-2 pb-4 pt-7">
                  <p className="text-[0.62rem] font-black uppercase tracking-[0.2em] text-[#E86F2A]">
                    {area.label}
                  </p>
                  <h3 className="mt-4 text-2xl font-black uppercase leading-[0.95] tracking-[-0.04em] text-[#242A32] md:text-3xl">
                    {area.title}
                  </h3>
                  <p className="mt-4 text-sm leading-7 text-[#65707D]">
                    {area.text}
                  </p>
                  <a
                    href="#projects"
                    className="mt-6 inline-flex items-center gap-2 text-[0.66rem] font-black uppercase tracking-[0.16em] text-[#242A32]"
                  >
                    Learn More{" "}
                    <ArrowDownRight className="h-4 w-4 text-[#E86F2A]" />
                  </a>
                </div>
              </article>
            ))}
      ...
      <section
        id="projects"
        className="border-y border-[#C9CDD2] bg-white px-5 py-24 lg:px-10 lg:py-32"
      >
        <div className="mx-auto max-w-[94rem]">
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            ...
            />
            <p className="max-w-md border-l-2 border-[#E86F2A] pl-5 text-sm leading-7 text-[#65707D]">
          ...
          <div className="mt-14 grid gap-7 lg:grid-cols-3">
            {projects.map((project, index) => (
              <article
                key={project.title}
                className="foundry-project group border border-[#D9DDE2] bg-[#F2F0EA]"
              >
                <div className="relative aspect-[16/11] overflow-hidden">
                  ...
                  />
                  <span className="absolute left-4 top-4 bg-[#E86F2A] px-3 py-2 text-[0.58rem] font-black uppercase tracking-[0.13em] text-white">
                    {project.status}
                  </span>
                ...
                <div className="p-6 lg:p-7">
                  <p className="flex items-center gap-2 text-[0.62rem] font-black uppercase tracking-[0.16em] text-[#65707D]">
                    <MapPin className="h-3.5 w-3.5 text-[#E86F2A]" />
                    {project.location}
                  </p>
                  <h3 className="mt-4 text-3xl font-black uppercase leading-[0.9] tracking-[-0.05em] text-[#242A32]">
                    {project.title}
                  </h3>
                  <div className="mt-5 border-y border-[#D1D4D7] py-3 text-[0.62rem] font-black uppercase tracking-[0.16em] text-[#E86F2A]">
                    {project.type}
                  </div>
                  <p className="mt-5 min-h-20 text-sm leading-7 text-[#65707D]">
                    {project.text}
                  </p>
                  <a
                    href="#contact"
                    className="mt-6 inline-flex w-full items-center justify-between bg-[#343A43] px-5 py-4 text-[0.66rem] font-black uppercase tracking-[0.16em] text-white transition hover:bg-[#E86F2A]"
                  >
      ...
      <section
        id="pipeline"
        className="relative bg-[#10141A] px-5 py-24 text-white lg:px-10 lg:py-32"
      >
        <img
          src={pipelineImage}
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#10141A] via-[#10141A]/95 to-[#10141A]/75" />
        <div className="relative mx-auto max-w-[94rem]">
          ...
          <div className="mt-14 grid border-l border-t border-white/15 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                <span className="block h-0.5 w-10 bg-[#E86F2A]" />
                <p className="mt-9 text-5xl font-black tracking-[-0.06em] text-[#E86F2A] lg:text-6xl">
                  {value}
                </p>
          ...
          <div>
            ...
            <div className="mt-9 grid gap-4">
              {[
                ...
                <div
                  key={point}
                  className="flex items-center gap-4 border-t border-[#D9DDE2] pt-4"
                >
                  <span className="text-sm font-black text-[#E86F2A]">
                    0{index + 1}
                  </span>
                  <p className="font-black uppercase tracking-[-0.02em] text-[#343A43]">
                    {point}
                  </p>
                </div>
              ))}
      ...
      <section
        id="investors"
        className="bg-[#F2F0EA] px-5 py-24 lg:px-10 lg:py-32"
      >
        <div className="mx-auto max-w-[94rem]">
          <div className="grid gap-12 lg:grid-cols-[.85fr_1.15fr] lg:items-end">
            ...
            />
            <div>
              <p className="max-w-xl text-base leading-8 text-[#65707D]">
          ...
          <div className="mt-14 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            {investorPrinciples.map(({ icon: Icon, number, title, text }) => (
              <article
                key={title}
                className="group bg-[#343A43] p-7 text-white transition duration-300 hover:-translate-y-1 hover:bg-[#10141A]"
              >
                <div className="flex items-center justify-between">
                  <Icon className="h-6 w-6 text-[#E86F2A]" />
          ...
          <div className="mt-3 grid overflow-hidden bg-[#10141A] lg:grid-cols-[1fr_1.2fr]">
            <img
              src={investorImage}
      ...
      <section
        id="communities"
        className="border-y border-[#D9DDE2] bg-white px-5 py-24 lg:px-10 lg:py-32"
      >
        <div className="mx-auto max-w-[94rem]">
          <FoundryHeading
          ...
          <div className="mt-14 grid gap-4 lg:grid-cols-3">
            {[
              ...
              <article
                key={title}
                className="group relative min-h-[32rem] overflow-hidden bg-[#343A43]"
              >
                <img
                  src={image}
                  alt={title}
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#10141A] via-[#10141A]/10 to-transparent" />
        ...
        <div className="mx-auto max-w-[94rem]">
          ...
          <div className="relative mt-16 grid gap-4 lg:grid-cols-5 lg:gap-0 before:absolute before:left-[10%] before:right-[10%] before:top-5 before:hidden before:h-px before:bg-[#AEB5BD] lg:before:block">
            {[
              ...
              <article
                key={number}
                className="relative bg-[#F2F0EA] p-6 lg:bg-transparent lg:px-5 lg:pt-0"
              >
                <span className="relative z-10 grid h-10 w-10 place-items-center bg-[#E86F2A] text-xs font-black text-white">
                  {number}
                </span>
                <h3 className="mt-8 text-lg font-black uppercase leading-tight tracking-[-0.03em]">
                  {title}
                </h3>
                <p className="mt-3 text-sm leading-6 text-[#65707D]">{text}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#D9DDE2] px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-[94rem]">
          ...
          <div className="mt-12 grid gap-px bg-[#B8BEC5] lg:grid-cols-3">
            {[
              [
                "Investment logic",
              ...
              <article key={title} className="group bg-white p-7 lg:p-9">
                <div className="flex items-center justify-between">
                  <span className="text-[0.6rem] font-black uppercase tracking-[0.2em] text-[#E86F2A]">
                    {label}
                  </span>
                  <span className="text-xs font-black text-[#B0B6BD]">
                    0{index + 1}
                  </span>
                </div>
                <h3 className="mt-10 text-2xl font-black uppercase leading-[1.02] tracking-[-0.045em]">
                  {title}
                </h3>
                <p className="mt-5 text-sm leading-7 text-[#65707D]">{text}</p>
                <a
                  href="#contact"
                  className="mt-8 inline-flex items-center gap-2 text-[0.65rem] font-black uppercase tracking-[0.16em]"
                >
                  Read Insight{" "}
                  <ChevronRight className="h-4 w-4 text-[#E86F2A] transition group-hover:translate-x-1" />
                </a>
              </article>
            ))}
          </div>
      ...
      <section
        id="contact"
        className="relative bg-[#10141A] px-5 py-28 text-white lg:px-10 lg:py-36"
      >
        <img
          src={ctaImage}
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,#10141A_0%,rgba(16,20,26,.9)_55%,rgba(16,20,26,.5)_100%)]" />
        ...
        <div className="relative mx-auto max-w-[94rem]">
          <div className="max-w-5xl">
            <p className="text-[0.65rem] font-black uppercase tracking-[0.26em] text-[#E86F2A]">
        ...
        <div className="mx-auto max-w-[94rem]">
          <div className="grid gap-10 border-b border-white/10 pb-12 md:grid-cols-2 lg:grid-cols-[1.35fr_.65fr_.8fr_1fr]">
            ...
            <div>
              ...
              <div className="mt-5 grid gap-3 text-sm text-white/45">
                <a href="mailto:hello@foundrypropertygroup.com">
                  hello@foundrypropertygroup.com
                </a>
                <a href="tel:2125550198">(212) 555-0198</a>
