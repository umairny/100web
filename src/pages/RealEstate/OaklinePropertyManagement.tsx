...
import heroImage from "../../assets/optimized/realestate/oakline/hero.webp";
import landlordImage from "../../assets/optimized/realestate/oakline/landlord.webp";
import tenantImage from "../../assets/optimized/realestate/oakline/tenant.webp";
import propertyImage from "../../assets/optimized/realestate/oakline/property.webp";
import serviceImage from "../../assets/optimized/realestate/oakline/core-service.webp";
import managementImage from "../../assets/optimized/realestate/oakline/management.webp";
import maintenanceImage from "../../assets/optimized/realestate/oakline/maintenance.webp";
import operationsImage from "../../assets/optimized/realestate/oakline/operations.webp";
import singleFamilyImage from "../../assets/optimized/realestate/oakline/single-family-rentals.webp";
import apartmentsImage from "../../assets/optimized/realestate/oakline/apartments.webp";
import multifamilyImage from "../../assets/optimized/realestate/oakline/multifamily.webp";
import ctaImage from "../../assets/optimized/realestate/oakline/cta.webp";
...
const supportCards = [
  {
    ...
    title: "Landlords",
    text: "Organized property oversight, tenant communication, leasing coordination, and service support designed to protect long-term value.",
    href: "#landlords",
  },
  {
    image: tenantImage,
    ...
    title: "Tenants",
    text: "Clear communication, responsive maintenance coordination, and helpful support for a better rental experience.",
    href: "#tenants",
  },
  {
    image: propertyImage,
    ...
    text: "Structured operations for single properties, small portfolios, and growing landlord needs.",
    href: "#property-types",
  },
];
...
const services = [
  {
    ...
    text: "Organized reminders, documentation, and owner-facing updates.",
  },
  {
    icon: Wrench,
    title: "Maintenance Coordination",
    text: "Requests reviewed, assigned, communicated, and followed through.",
  },
  {
    icon: MessageSquareText,
    title: "Tenant Communication",
    text: "Clear, professional updates across everyday property needs.",
  },
  {
    icon: KeyRound,
    title: "Leasing Support",
    text: "Practical coordination for inquiries, showings, and documentation.",
  },
  {
    icon: ClipboardCheck,
    title: "Property Inspections",
    text: "Structured observations and documented property condition notes.",
  },
  {
    icon: UsersRound,
    title: "Vendor Coordination",
    text: "Reliable communication with qualified service providers.",
  },
  {
    icon: FileText,
    title: "Owner Reporting",
    text: "Useful summaries that make property activity easier to follow.",
  },
  {
    icon: RefreshCw,
    title: "Move-In / Move-Out Support",
    text: "Consistent checklists and clear transition coordination.",
  },
];
...
function OakLogo({ light = false }: { light?: boolean }) {
  return (
    <a
      href="#home"
    ...
    >
      ...
      <span>
        <strong className="block text-base font-black leading-none tracking-[-0.025em]">
          Oakline
        </strong>
        <span
...
export function OaklinePropertyManagement() {
    ...
    <main className="oakline-site overflow-hidden bg-[#F2F7F5] text-[#334047] selection:bg-[#8FA377] selection:text-white">
      ...
      <section id="home" className="relative pt-[4.5rem]">
        <div className="mx-auto grid min-h-[47rem] max-w-[100rem] lg:grid-cols-[.9fr_1.1fr]">
          <div className="relative flex items-center bg-[#F2F7F5] px-5 py-20 lg:px-12 xl:px-20">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <OakButton href="#landlords">For Landlords</OakButton>
                <OakButton href="#tenants" secondary>
                  For Tenants
                </OakButton>
              </div>
            </div>
          ...
          <div className="relative min-h-[36rem]">
            <img
              src={heroImage}
              alt="Well-maintained modern apartment property managed by Oakline"
        ...
        <div className="mx-auto grid max-w-[90rem] -translate-y-1/2 grid-cols-1 overflow-hidden rounded-2xl border border-[#D9E2E0] bg-white shadow-xl sm:grid-cols-3">
          {[
            ...
            [UsersRound, "Landlord & Tenant Support"],
          ].map(([Icon, label]) => {
            const InfoIcon = Icon as typeof Wrench;
            return (
              <div
                key={label as string}
      ...
      <section className="px-5 pb-24 pt-8 lg:px-10 lg:pb-32">
        <div className="mx-auto max-w-[90rem]">
          <OakHeading
            label="Who we help"
            title="Support for Every Side of the Property"
            text="Dependable management starts by understanding what owners, tenants, and growing portfolios need day to day."
          />
        ...
        <div className="mx-auto max-w-[90rem]">
          <div className="grid gap-10 lg:grid-cols-[.8fr_1.2fr] lg:items-end">
            <OakHeading
              ...
              title="Property Management Services Built Around Clarity"
            />
            <div className="relative hidden overflow-hidden rounded-2xl lg:block">
              <img
                src={serviceImage}
                alt="Oakline property management service coordination"
                className="h-60 w-full object-cover"
              />
              <div className="absolute inset-0 bg-[#16324A]/20" />
            </div>
          </div>
      ...
      <section id="landlords" className="px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto grid max-w-[90rem] overflow-hidden rounded-[2rem] bg-[#16324A] lg:grid-cols-2">
          <div className="flex items-center p-8 text-white md:p-12 lg:p-16">
            <div>
              <OakHeading
                ...
                title="Protect Your Property with Organized Management"
                text="We help landlords reduce day-to-day stress with structured communication, maintenance coordination, vendor follow-up, and clear operational routines."
                light
              />
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  "Tenant support and follow-up",
                  "Organized property oversight",
                ].map((item) => (
                  <div
                    key={item}
              ...
              <OakButton href="#contact" className="mt-8">
                Request Management
              </OakButton>
            </div>
          </div>
          <img
            src={managementImage}
            alt="Organized residential property management for landlords"
            className="h-full min-h-[36rem] w-full object-cover"
          />
        </div>
      </section>
      ...
      >
        <div className="mx-auto grid max-w-[90rem] gap-12 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          ...
          <div>
            <OakHeading
              label="Tenant support"
              title="A Better Rental Experience Starts with Responsive Service"
              text="Tenants need clear answers, timely updates, and a simple way to get help when something needs attention. Oakline keeps communication calm, organized, and helpful."
            />
            <div className="mt-8 grid gap-3">
              {[
                [
                  Wrench,
                  "Maintenance Help",
                  "A clear path for reporting issues and receiving practical updates.",
                ],
                [
                  KeyRound,
                  "Move-In Guidance",
                  "Organized information to make the transition into a new home easier.",
                ],
                [
                  MessageSquareText,
                  "Clear Communication",
                  "Professional responses and documented next steps across property needs.",
                ],
              ].map(([Icon, title, text]) => {
                const SupportIcon = Icon as typeof Wrench;
                return (
                  <article
                    key={title as string}
      ...
      <section id="maintenance" className="px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-[90rem]">
          <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:items-center">
            <div>
              <OakHeading
                label="Maintenance coordination"
                title="Maintenance Coordination Without the Confusion"
                text="From routine repairs to urgent service requests, our process helps keep property issues organized, documented, and moving forward."
              />
              <img
                src={maintenanceImage}
                alt="Maintenance coordination for a managed rental property"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                [
                  "01",
                  "Request Received",
                  "Maintenance issue is reviewed and categorized.",
                ],
                [
                  "02",
                  "Vendor Coordinated",
                  "The right service provider is contacted when needed.",
                ],
                [
                  "03",
                  "Updates Shared",
                  "Landlords and tenants receive clear communication.",
                ],
                [
                  "04",
                  "Issue Followed Through",
                  "Work is tracked until the issue is resolved or next steps are clear.",
                ],
      ...
      <section className="relative bg-[#16324A] px-5 py-24 text-white lg:px-10 lg:py-32">
        ...
        <div className="relative mx-auto max-w-[90rem]">
          <OakHeading
            ...
            title="Clear Systems. Calm Communication. Better Oversight."
            text="Our approach is designed around transparency, documentation, and dependable follow-through so landlords and tenants know what is happening."
            light
          />
          <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {[
              [
                ClipboardCheck,
                "Documented Requests",
                "Property needs are logged with context and useful next steps.",
              ],
              [
                FileText,
                "Organized Reporting",
                "Owners receive practical summaries of relevant property activity.",
              ],
              [
                UsersRound,
                "Vendor Follow-Up",
                "Service coordination includes communication after assignment.",
              ],
              [
                MessageSquareText,
                "Consistent Communication",
                "Clear updates help reduce uncertainty for everyone involved.",
              ],
            ].map(([Icon, title, text]) => {
              const ValueIcon = Icon as typeof ClipboardCheck;
              return (
                <article
                  key={title as string}
      ...
      >
        <div className="mx-auto max-w-[90rem]">
          <OakHeading
            label="Managed portfolio"
            title="Management for Practical Rental Portfolios"
            text="Flexible operating support for common residential property types and evolving ownership needs."
          />
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {[
              [
                ...
                "Dedicated oversight for individual homes and long-term rental operations.",
              ],
              [
                apartmentsImage,
                "Apartment Buildings",
                "Coordinated resident communication and property routines across multiple units.",
              ],
              [
                multifamilyImage,
                "Small Multi-Family",
                "Structured support that keeps shared property needs organized and visible.",
              ],
              [
                propertyImage,
                "Mixed Residential Portfolios",
                "Consistent management practices across varied residential holdings.",
              ],
      ...
      <section className="border-y border-[#D9E2E0] bg-[#E8F0EC] px-5 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-[90rem]">
          <OakHeading
            label="Resources"
            title="Helpful Property Management Guides"
          />
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {[
              [
                "Owner expectations",
                "What Landlords Should Expect from Property Management",
                "A practical overview of communication, maintenance coordination, reporting, leasing support, and the boundaries set by a management agreement.",
              ],
              [
                "Maintenance process",
                "How Maintenance Requests Are Usually Handled",
                "What happens after an issue is reported, from initial review and vendor assignment through updates and follow-up.",
              ],
              [
                "Better communication",
                "Clear Communication Tips for Tenants and Owners",
                "Simple ways to share useful details, set expectations, document updates, and keep property conversations productive.",
              ],
            ].map(([tag, title, text]) => (
              <article
                key={title}
        ...
        <div className="relative mx-auto max-w-[90rem]">
          <div className="max-w-4xl">
            ...
            <h2 className="mt-5 text-[clamp(3rem,6.8vw,6.5rem)] font-black leading-[0.9] tracking-[-0.065em]">
              Ready for More Organized Property Management?
            </h2>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/68">
              Connect with Oakline Property Management to discuss landlord
              support, tenant communication, maintenance coordination, and
              transparent operations.
            </p>
            <OakButton href="mailto:hello@oaklinepm.com" className="mt-9">
          ...
          <div className="grid gap-10 border-b border-white/10 pb-12 md:grid-cols-2 lg:grid-cols-[1.35fr_.65fr_.8fr_1fr]">
            <div>
              ...
              <p className="mt-6 max-w-sm text-sm leading-7 text-white/45">
                Property management for landlords and tenants with responsive
            ...
            <div>
              ...
              <div className="mt-5 grid gap-3 text-sm text-white/45">
                <a href="#services">Rent Support</a>
                <a href="#maintenance">Maintenance</a>
                <a href="#services">Leasing Support</a>
                <a href="#services">Owner Reporting</a>
              </div>
            </div>
            <div>
              <p className="font-black">Contact</p>
              <div className="mt-5 grid gap-3 text-sm text-white/45">
                <a href="mailto:hello@oaklinepm.com">hello@oaklinepm.com</a>
                <a href="tel:2125550126">(212) 555-0126</a>
                <span>New York, NY</span>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-3 pt-7 text-[0.67rem] text-white/30 md:flex-row md:justify-between">
            <p>© 2026 Oakline Property Management. All rights reserved.</p>
            <p>
              Services, response times, pricing, and availability may vary by
