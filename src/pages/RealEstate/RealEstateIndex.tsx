            ...
            {liveWebsites.map((website) => (
              ...
              >
                ...
                >
                  ...
                  <div className={`absolute inset-0 ${website.image ? 'bg-gradient-to-t from-slate-950/45 via-slate-950/5 to-transparent' : 'bg-[linear-gradient(90deg,rgba(255,255,255,0.24)_1px,transparent_1px),linear-gradient(180deg,rgba(255,255,255,0.24)_1px,transparent_1px)] [background-size:44px_44px]'}`} />
