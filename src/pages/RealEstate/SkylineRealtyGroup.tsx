...
const sellerSteps = [
  [
    "01",
    "Price the market",
    "Comparable sales, buyer demand, and timing are mapped before launch.",
  ],
  [
    "02",
    "Stage the story",
    "Photography, copy, floor plan, and lifestyle positioning create stronger first impressions.",
  ],
  [
    "03",
    "Negotiate cleanly",
    "Offer strategy, inspection terms, and closing details stay organized from start to finish.",
  ],
];
...
const servicePaths = [
  [
    "For buyers",
    "Focused searches, tour planning, offer strategy, and neighborhood context.",
  ],
  [
    "For sellers",
    "Pricing, preparation, launch positioning, negotiation, and closing guidance.",
  ],
  [
    "For investors",
    "Property comparison, rent-position thinking, risk context, and acquisition support.",
  ],
];
...
const testimonials = [
  {
    quote:
      "Maya turned a noisy market into three clear decisions. We never felt rushed, and every tour had a purpose.",
    name: "Nora & Julian",
    role: "River North buyers",
  },
  {
    quote:
      "The launch plan made our home feel distinct from day one. Communication stayed direct all the way through closing.",
    name: "Avery R.",
    role: "Crescent Hill seller",
  },
  {
    quote:
      "Skyline brought disciplined numbers and strong neighborhood judgment to an investment search that had stalled.",
    name: "Marcus T.",
...
const faqs = [
  [
    ...
    "Search planning, property comparison, tour coordination, offer strategy, inspection guidance, and closing support are included in the demo service journey.",
  ],
  [
    "How quickly can I request a tour?",
    "Use any Request Tour button to prefill the consultation form. Skyline positions the demo response promise as a tour plan within 24 hours.",
  ],
  [
    "When should a seller begin preparing?",
    "Ideally four to eight weeks before launch so pricing, repairs, staging, photography, and timing can be considered without pressure.",
  ],
  [
    "How are fees handled?",
    "Fees and representation terms would be explained before an engagement begins. This portfolio concept does not quote or collect real fees.",
  ],
  [
    "What happens during the first consultation?",
    "The first conversation clarifies goals, timing, budget or property context, and the next useful action. No information is transmitted from this demo.",
  ],
];
...
export function SkylineRealtyGroup() {
  ...
  const filteredListings = useMemo(() => {
    const ceiling =
      maxPrice === "Any" ? Number.POSITIVE_INFINITY : Number(maxPrice);

    return listings.filter(
      (listing) =>
        (neighborhoodFilter === "All" ||
          listing.neighborhood === neighborhoodFilter) &&
  ...
  const focusInquiry = (intent: string, property = "") => {
    setForm((current) => ({
      ...
      property,
      message: property
        ? `I would like to arrange a tour of ${property}.`
        : current.message,
    }));
    setSubmitted(false);
    window.setTimeout(() => {
  ...
  const validateForm = () => {
    ...
    if (form.message.trim().length < 10)
      nextErrors.message = "Tell us a little more about your plans.";
    ...
    <main className="bg-[#f5f8fb] text-[#0f172a]">
        ...
        <Container>
          <div className="relative grid min-h-[680px] gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
            <div className="max-w-3xl">
              <p className="text-sm font-black uppercase tracking-[0.26em] text-[#fbbf24]">
              ...
              <p className="mt-7 max-w-2xl text-lg leading-8 text-white/75">
                Premium representation for buyers, sellers, and investors who
                want sharp strategy, neighborhood context, and calm negotiation
                from first tour to close.
              </p>
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                <CTAButton
                  href="#listings"
                  size="lg"
                  className="bg-[#fbbf24] text-[#0f172a] hover:bg-white"
                >
                  Explore Properties
                </CTAButton>
                <CTAButton
            ...
            <div className="self-end lg:justify-self-end">
              <div className="w-full max-w-xl border border-white/15 bg-white/10 p-5 shadow-2xl backdrop-blur-md">
                ...
                <h2 className="mt-3 text-3xl font-black">
                  A focused tour plan within 24 hours.
                </h2>
                <div className="mt-6 grid grid-cols-3 divide-x divide-white/15 border-y border-white/15">
                  {[
                    ...
                    <div key={label} className="px-3 py-5 text-center">
                      ...
                      <p className="mt-1 text-[0.65rem] font-black uppercase tracking-[0.13em] text-white/55">
                        {label}
                      </p>
                    </div>
                  ))}
                ...
                <button
                  ...
                  className="mt-6 w-full bg-white px-5 py-4 text-sm font-black text-[#153e75] transition hover:bg-[#fbbf24] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white"
                >
      ...
      <section id="listings" className="scroll-mt-32 py-20 md:py-28">
        <Container>
          <div className="mb-10 grid gap-6 lg:grid-cols-[.85fr_1.15fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-black leading-tight md:text-5xl">
                Homes with a clear buyer story.
              </h2>
            </div>
            <p className="max-w-2xl text-lg leading-8 text-slate-600">
              Compare location, property type, price, and space without losing
              the details that make a home distinctive.
            </p>
          </div>

          <div
            aria-label="Filter featured listings"
            className="mb-8 grid gap-4 border border-[#dbe4ef] bg-white p-5 shadow-sm sm:grid-cols-3"
          >
            <label className="text-sm font-black text-slate-700">
              ...
              <select
                ...
                className="mt-2 min-h-12 w-full border border-slate-300 bg-white px-3 font-medium"
              >
                <option>All</option>
          ...
          <p
            className="mb-5 text-sm font-bold text-slate-500"
            aria-live="polite"
          >
          ...
          {filteredListings.length > 0 ? (
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {filteredListings.map((listing) => (
                <article
                  key={listing.id}
                  className="group flex flex-col overflow-hidden border border-[#dbe4ef] bg-white shadow-sm transition motion-reduce:transition-none motion-safe:hover:-translate-y-1 motion-safe:hover:shadow-xl"
                >
                  <EditorialImage
                    src={listing.image}
                    alt={`${listing.title} at ${listing.address}`}
                    tone={listing.tone}
                    className="aspect-[16/10] w-full object-cover transition duration-500 motion-reduce:transition-none motion-safe:group-hover:scale-105"
                  />
                  <div className="flex flex-1 flex-col p-6">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className="text-3xl font-black text-[#153e75]">
                          {listing.priceLabel}
                        </p>
                      ...
                      <span className="rounded-full bg-[#eff6ff] px-3 py-1 text-xs font-black uppercase tracking-wide text-[#153e75]">
                    ...
                    <dl className="mt-6 grid grid-cols-3 border-y border-slate-200 py-4 text-center">
                      <div>
                        ...
                        <dd className="mt-1 font-black">{listing.beds}</dd>
                      </div>
                      <div>
                        <dt className="text-xs text-slate-500">Baths</dt>
                        <dd className="mt-1 font-black">{listing.baths}</dd>
                      </div>
                      <div>
                        <dt className="text-xs text-slate-500">Sq ft</dt>
                    ...
                    <button
                      type="button"
                      onClick={() => focusInquiry("Buy", listing.title)}
                      className="mt-6 min-h-12 w-full rounded-lg bg-[#0f172a] px-4 py-3 text-sm font-bold text-white transition hover:bg-[#153e75] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#153e75]"
                    >
                      Request Tour
                    </button>
                  </div>
            ...
            <div className="border border-dashed border-[#9aadc4] bg-white px-6 py-14 text-center">
              <h3 className="text-2xl font-black">
                No featured homes match those filters.
              </h3>
              <p className="mt-3 text-slate-600">
                Reset the search to see all three Skyline properties.
              </p>
              <button
                type="button"
                onClick={clearFilters}
                className="mt-6 rounded-lg bg-[#153e75] px-5 py-3 text-sm font-black text-white hover:bg-[#0f172a]"
              >
                Clear Filters
              </button>
            </div>
      ...
      >
        <Container>
          <div className="grid gap-12 lg:grid-cols-[.78fr_1.22fr] lg:items-center">
            <EditorialImage
              src={agentImage}
              alt="Maya Bennett, fictional principal broker at Skyline Realty"
              tone="from-[#dbeafe] via-[#365f8b] to-[#0f172a]"
              className="aspect-[4/5] w-full object-cover"
            />
            <div>
              <p className="text-sm font-black uppercase tracking-[0.24em] text-[#fbbf24]">
                Meet your market strategist
              </p>
              <h2 className="mt-4 text-4xl font-black leading-tight md:text-6xl">
                Maya Bennett, Principal Broker
              </h2>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70">
                Maya pairs disciplined market preparation with calm, direct
                advice. Her role is to make every tradeoff visible before it
                becomes expensive—and to keep the human decision at the center
                of the numbers.
              </p>
        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-black leading-tight md:text-5xl">
                A calmer launch with fewer surprises.
              </h2>
              <div className="mt-9 space-y-4">
                {sellerSteps.map(([number, title, text]) => (
                  <article
                    key={title}
                    className="grid grid-cols-[auto_1fr] gap-5 border border-[#dbe4ef] bg-white p-6 shadow-sm"
                  >
              ...
              <button
                type="button"
                onClick={() => focusInquiry("Sell")}
                className="mt-7 rounded-lg bg-[#153e75] px-6 py-4 text-sm font-black text-white transition hover:bg-[#0f172a]"
              >
                Plan My Sale
              </button>
            </div>
            <EditorialImage
              src={sellerImage}
              alt="Seller and agent reviewing a property presentation"
              tone="from-[#f8fafc] via-[#c9a96d] to-[#153e75]"
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-stretch">
            <div className="relative overflow-hidden">
              <EditorialImage
                ...
                alt="Fictional Skyline clients reviewing property information"
              ...
              <div className="absolute inset-x-5 bottom-5 bg-[#0f172a]/92 p-6 text-white backdrop-blur">
                ...
                <p className="mt-4 text-sm font-black text-[#fbbf24]">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h2 className="mt-3 text-4xl font-black leading-tight md:text-5xl">
                Clear advice travels well.
              </h2>
              <div className="mt-8 grid gap-5">
                {testimonials.slice(1).map((item) => (
                  <blockquote
                    key={item.name}
                    className="border-l-4 border-[#f59e0b] bg-[#f5f8fb] p-6"
                  >
                    <p className="text-lg font-bold leading-8">
                      “{item.quote}”
                    </p>
                    <footer className="mt-4 text-sm font-black text-[#153e75]">
                      {item.name} · {item.role}
                    </footer>
                  </blockquote>
                ))}
              ...
              <p className="mt-5 text-xs text-slate-500">
                Testimonials are fictional and shown for portfolio
                demonstration.
              </p>
            </div>
          </div>
                  ...
                  <article key={question}>
                    <h3>
                      <button
                        ...
                        className="flex w-full items-center justify-between gap-5 py-6 text-left text-lg font-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#153e75]"
                      >
                        {question}
                        <span
                          aria-hidden="true"
                          className="text-2xl text-[#153e75]"
                        >
                          {isOpen ? "−" : "+"}
                        </span>
                      </button>
                    ...
                    {isOpen && (
                      <div
                        id={`faq-panel-${index}`}
                        className="pb-6 pr-10 text-sm leading-7 text-slate-600"
                      >
                        {answer}
                      </div>
                    )}
          ...
          <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr]">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-black leading-tight md:text-5xl">
                Build a focused plan for your next move.
              </h2>
              <p className="mt-5 text-lg leading-8 text-white/70">
                Share what you are trying to buy, sell, or evaluate. This
                interactive portfolio form demonstrates the experience without
                transmitting or storing your information.
              </p>
              <div className="mt-8 space-y-3 text-sm font-bold text-white/70">
                <a
                  href="tel:+15550301000"
                  className="block hover:text-[#fbbf24]"
                >
                  (555) 030-1000
                </a>
                <a
                  href="mailto:hello@skylinerealty.example"
                  className="block hover:text-[#fbbf24]"
                >
                  hello@skylinerealty.example
                </a>
              </div>
            </div>
            ...
            <div className="bg-white p-6 text-[#0f172a] shadow-2xl md:p-8">
              {submitted ? (
                ...
                >
                  <span
                    className="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-100 text-3xl text-emerald-700"
                    aria-hidden="true"
                  >
                    ✓
                  </span>
                  <h3 className="mt-6 text-3xl font-black">
                    Your demo inquiry is ready.
                  </h3>
                  <p className="mt-4 max-w-lg leading-7 text-slate-600">
                    Nothing was sent or stored. In a production site, Skyline
                    would now receive your consultation request.
                  </p>
                  <button
                    type="button"
                    onClick={resetInquiry}
                    className="mt-7 rounded-lg bg-[#153e75] px-6 py-3 text-sm font-black text-white hover:bg-[#0f172a]"
                  >
                ...
                <form noValidate onSubmit={submitInquiry}>
                  <p className="text-sm font-black uppercase tracking-[0.2em] text-[#153e75]">
                  ...
                  {Object.keys(errors).length > 0 && (
                    <div
                      ...
                      tabIndex={-1}
                      role="alert"
                      className="mt-5 border border-red-300 bg-red-50 p-4 text-sm font-bold text-red-800"
                    >
                  ...
                  <div className="mt-6 grid gap-5 sm:grid-cols-2">
                    <label className="text-sm font-bold">
                      ...
                      <select
                        value={form.intent}
                        onChange={(event) =>
                          updateForm("intent", event.target.value)
                        }
                        className="mt-2 min-h-12 w-full border border-slate-300 bg-white px-3"
                      >
                        <option>Buy</option>
                        <option>Sell</option>
                    ...
                    <label className="text-sm font-bold">
                      ...
                      >
                        ...
                        {listings.map((listing) => (
                          <option key={listing.id}>{listing.title}</option>
                        ))}
                      </select>
                    </label>
                    <label className="text-sm font-bold">
                      ...
                      <input
                        ...
                        className="mt-2 min-h-12 w-full border border-slate-300 px-3"
                      />
                      {errors.name && (
                        <span
                          id="name-error"
                  ...
                  <label className="mt-5 block text-sm font-bold">
                    ...
                    <textarea
                      ...
                      aria-describedby={
                        errors.message ? "message-error" : "privacy-note"
                      }
                  ...
                  >
                    Demo only: submitting does not send, save, or persist
                    personal information.
                  </p>
                  <button
                    type="submit"
                    className="mt-6 min-h-12 w-full bg-[#153e75] px-5 py-4 text-sm font-black text-white transition hover:bg-[#0f172a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#153e75]"
                  >
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-end">
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm leading-6 text-white/55">
                Fictional real-estate brand and market content created for a
                portfolio demonstration. Not an operating brokerage.
              </p>
            </div>
            <div className="flex flex-wrap gap-5 text-sm font-bold text-white/65">
              ...
              <a href="#neighborhoods" className="hover:text-white">
                Neighborhoods
              </a>
