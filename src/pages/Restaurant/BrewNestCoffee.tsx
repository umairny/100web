          ...
          {Array.from({ length: 12 }).map((_, index) => (
            <span
              ...
              className={`h-3 w-5 rounded-full border border-[#8d6748]/20 ${
                index % 2 === 0
                  ? "rotate-12 bg-[#c9ab86]/30"
                  : "-rotate-12 bg-[#a77f5a]/20"
              }`}
            />
          ))}
        </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-[#5f4a3d] md:text-xl">
                BrewNest is a neighborhood coffee house built around careful
                roasting, warm hospitality, and the kind of room that invites
                you to stay for one more cup.
              </p>
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <CTAButton
                  href="#menu"
                  size="lg"
                  className="bg-[#2d211a] hover:bg-[#6c4a34]"
                >
                  Explore Menu
                </CTAButton>
                <CTAButton
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={stat.label}
                    className="rounded-2xl border border-[#e4d6c5] bg-white/75 p-4 shadow-sm"
                  >
                    <p className="text-3xl font-black text-[#2d211a]">
                      {stat.value}
                    </p>
                    <p className="mt-1 text-xs font-black uppercase tracking-[0.16em] text-[#8d6748]">
                      {stat.label}
                    </p>
                  </div>
                ))}
              ...
              <div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr]">
                <div className="rounded-[2rem] border border-[#dccbb7] bg-white/80 p-5 shadow-[0_28px_60px_rgba(77,55,38,0.12)] backdrop-blur">
                  <div className="rounded-[1.6rem] bg-[linear-gradient(145deg,#6c4a34,#9d7451_38%,#e9dccd_39%,#f7efe5_100%)] p-6">
                    ...
                    <div className="mt-6 rounded-2xl bg-white/75 p-4">
                      <p className="text-xs font-black uppercase tracking-[0.18em] text-[#8d6748]">
                        House Pour
                      </p>
                      <p className="mt-2 text-2xl font-black text-[#2d211a]">
                        Velvet Roast Latte
                      </p>
                      <p className="mt-2 text-sm leading-6 text-[#5f4a3d]">
                        Soft caramel sweetness, balanced espresso, and a silky
                        finish.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="rounded-[2rem] border border-[#dccbb7] bg-[#2d211a] p-5 text-white shadow-xl">
                    <p className="text-xs font-black uppercase tracking-[0.18em] text-[#d9b274]">
                      Morning Menu
                    </p>
            ...
            {signatureDrinks.map((drink) => (
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(45,33,26,0.02),rgba(45,33,26,0.24))]" />
            ...
            <div>
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <CTAButton
                  ...
                  size="lg"
                  className="bg-[#d9b274] text-[#2d211a] hover:bg-[#caa56f]"
                >
                  Call the Cafe
                </CTAButton>
                <CTAButton
