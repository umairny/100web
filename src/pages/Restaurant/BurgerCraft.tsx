...
const burgerImages = {
  hero: imageUrl("restaurent/burger-craft/hero.webp"),
  smash: imageUrl("restaurent/burger-craft/smash.webp"),
  fries: imageUrl("restaurent/burger-craft/golden.webp"),
  sauces: imageUrl("restaurent/burger-craft/sauces.webp"),
  shake: imageUrl("restaurent/burger-craft/shake.webp"),
  combo: imageUrl("restaurent/burger-craft/combo.webp"),
};
...
const favorites = [
  {
    title: "Smash Burgers",
    text: "Smashed thin, seared crispy, stacked with flavor.",
    image: burgerImages.smash,
    color: "#c82b24",
    icon: "burger",
  },
  {
    title: "Golden Fries",
    text: "Crispy on the outside, soft and fluffy inside.",
    image: burgerImages.fries,
    color: "#e7a315",
    icon: "fries",
  },
  {
    title: "House Sauces",
    text: "Bold, craveable flavors made fresh in-house daily.",
    image: burgerImages.sauces,
    color: "#5c8a2a",
    icon: "bottle",
  },
  {
    title: "Thick Shakes",
    text: "Rich, creamy, and thick—the perfect finish.",
    image: burgerImages.shake,
    color: "#8a4a2b",
    icon: "shake",
  },
];
...
const values = [
  [
    "leaf",
    "Quality ingredients",
    "Premium, responsibly sourced ingredients you can taste.",
  ],
  [
    "burger",
    "Smashed to perfection",
    "Our smash technique locks in flavor and creates a crisp crust.",
  ],
  [
    "flame",
    "Cooked to order",
    "Every item is cooked fresh, never sitting under a heat lamp.",
  ],
  [
    "heart",
    "Made with care",
    "From our kitchen to your tray—made by people who care.",
  ],
];

const reviews = [
  [
    "“Best smash burger I’ve ever had.” Everything is fresh and full of flavor.",
    "Jason M.",
  ],
  [
    "Fries are perfect. Sauces are next level. This place never misses.",
    "Sarah T.",
  ],
...
function Icon({
  ...
  const paths: Record<string, ReactNode> = {
    burger: (
      <>
        <path d="M4 11c.6-4.1 3.4-6 8-6s7.4 1.9 8 6H4ZM3 14h18M5 17h14l-1 3H6l-1-3Z" />
        <path d="m6 14 2 2 2-2 2 2 2-2 2 2 2-2" />
      </>
    ),
    fries: (
      <>
        <path d="m7 3 1 9M11 2l1 10M16 3l-1 9M4 10h16l-2 11H6L4 10Z" />
      </>
    ),
    bottle: (
      <>
        <path d="M9 3h6v4l2 3v11H7V10l2-3V3ZM9 14h8" />
      </>
    ),
    shake: (
      <>
        <path d="M7 7h10l-1 14H8L7 7ZM5 4h14M14 7l3-5" />
      </>
    ),
    leaf: (
      <>
        <path d="M20 3C9 4 4 9 5 18c8 1 13-4 15-15Z" />
        <path d="M5 21c3-7 7-10 13-15" />
      </>
    ),
    flame: (
      <path d="M13 2.5c.5 4.2-3.4 5.4-2 9.1 1-1.7 2.4-2.6 3.7-3.4 2.2 2.4 3.8 4.8 3.8 8A6.6 6.6 0 0 1 12 22.8a6.6 6.6 0 0 1-6.6-6.6C5.4 11.5 8.4 8 13 2.5Z" />
    ),
    heart: (
      <path d="M20.8 5.7c-2.2-2.1-5.6-1.8-7.5.4L12 7.6l-1.3-1.5C8.8 3.9 5.4 3.6 3.2 5.7 1 8 1.2 11.6 3.7 13.8L12 21l8.3-7.2c2.5-2.2 2.7-5.8.5-8.1Z" />
    ),
    arrow: <path d="M5 12h14M14 7l5 5-5 5" />,
    user: (
      <>
        <circle cx="12" cy="8" r="3.5" />
        <path d="M5 21c.4-4.3 2.7-6.5 7-6.5s6.6 2.2 7 6.5" />
      </>
    ),
    bag: (
      <>
    ...
    rewards: (
      <>
        <path d="M4 9h16v12H4zM3 9h18M12 9v12" />
        <path d="M12 9H8.5a2.5 2.5 0 1 1 2.5-3.8L12 9Zm0 0h3.5A2.5 2.5 0 1 0 13 5.2L12 9Z" />
      </>
    ),
    pin: (
      <>
        <path d="M20 10c0 5.6-8 12-8 12S4 15.6 4 10a8 8 0 1 1 16 0Z" />
    ...
    phone: (
      <path d="M7 3H4.5A1.5 1.5 0 0 0 3 4.5C3 13.6 10.4 21 19.5 21a1.5 1.5 0 0 0 1.5-1.5V17l-5-1-1.2 3c-4.4-1.8-8-5.4-9.8-9.8L8 8 7 3Z" />
    ),
  };
  return (
    <svg
...
export function BurgerCraft() {
  ...
  const isNavActive = (href: string) => {
    ...
    if (target === "menu")
      return activeSection === "menu" || activeSection === "order";
    ...
    <main className="motion-burgercraft min-h-screen overflow-x-hidden bg-[#fffcf7] text-[#211c18]">
      <header className="fixed inset-x-0 top-0 z-50 border-b border-[#d9c9b8] bg-[#fffdf9]/95 shadow-sm backdrop-blur-xl">
        <div className="mx-auto flex h-20 max-w-[1440px] items-center justify-between px-5 sm:px-8 lg:px-12">
          ...
          <nav
            aria-label="Built Fresh navigation"
      ...
      <section
        id="home"
        className="relative isolate min-h-[720px] pt-20 sm:min-h-[790px]"
      >
        <img
          src={burgerImages.hero}
            ...
            {favorites.map((item, index) => (
              ...
              >
                <div className="relative aspect-[1.45] overflow-hidden">
                  ...
                  />
                  <span
                    className="absolute -bottom-7 left-5 grid h-14 w-14 place-items-center rounded-full border-[3px] border-white text-white shadow-lg"
      ...
      <section id="order" className="px-5 py-8 sm:px-8">
        ...
        >
          <img
            src={burgerImages.combo}
            alt="Signature burger combo with fries and shake"
            loading="lazy"
      ...
      <section className="px-5 py-4 sm:px-8">
        ...
        >
          ...
          {[
            ["cart", "Order online", "Fast & easy ordering"],
            ["truck", "Pickup or delivery", "Get it your way"],
            ["rewards", "Earn rewards", "Points with every order"],
          ].map(([icon, title, text]) => (
        ...
        <div className="relative mx-auto max-w-[1240px] px-5 sm:px-8">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-[1.04fr_0.96fr]">
            ...
            <div className="relative min-h-[430px] overflow-hidden rounded-[1.6rem] border border-[#d8c7b5] bg-[#f1e6d9] shadow-[0_18px_50px_rgba(67,40,23,0.1)]">
              ...
              {[
                ["Nashville", "left-[52%] top-[38%]"],
                ["Franklin", "left-[30%] top-[67%]"],
                ["Brentwood", "left-[64%] top-[61%]"],
              ].map(([city, position], index) => (
                <div
                  key={city}
              ...
              <div className="absolute bottom-5 left-5 right-5 rounded-2xl bg-[#211c18]/95 p-5 text-white shadow-2xl backdrop-blur">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="rounded-full bg-[#5f8c2f] px-3 py-2 text-[0.52rem] font-black uppercase tracking-[0.08em]">
                    Open now
                  </span>
                </div>
                <p className="mt-3 text-xs text-white/55">
                  About 8 minutes away · Pickup ready in 15–20 min
                </p>
              </div>
            </div>
          </div>
