...
const bakeryImages = {
  hero: imageUrl("restaurent/golden-crust-bakery/golden-crust-hero-bakery.webp"),
  rewardPastry: imageUrl(
    "restaurent/golden-crust-bakery/golden-rewards-pastry-card.webp",
  ),
  interior: imageUrl(
    "restaurent/golden-crust-bakery/golden-crust-interior.webp",
  ),
  displayCounter: imageUrl(
    "restaurent/golden-crust-bakery/bakery-display-counter.webp",
  ),
  benefitsBg: imageUrl(
    "restaurent/golden-crust-bakery/rewards-benefits-bg.webp",
  ),
  finalCta: imageUrl(
    "restaurent/golden-crust-bakery/golden-crust-final-cta.webp",
  ),
};
...
const menuItems = [
  {
    ...
    price: "$4.75",
    badge: "Baker’s pick",
    image: imageUrl("restaurent/golden-crust-bakery/butter-croissant.webp"),
  ...
  },
  {
    ...
    price: "$9.50",
    badge: "Daily bake",
    image: imageUrl("restaurent/golden-crust-bakery/sourdough-loaf.webp"),
  ...
  },
  {
    ...
    price: "$6.25",
    badge: "Classic",
    image: imageUrl("restaurent/golden-crust-bakery/chocolate-eclair.webp"),
  ...
  },
  {
    ...
    price: "$8.00",
    badge: "Seasonal",
    image: imageUrl("restaurent/golden-crust-bakery/strawberry-cream-cake.webp"),
  ...
  },
  {
    ...
    image: imageUrl("restaurent/golden-crust-bakery/cinnamon-roll.webp"),
  ...
  },
  {
    ...
    price: "$5.50",
    badge: "Barista bar",
    image: imageUrl("restaurent/golden-crust-bakery/iced-latte.webp"),
...
const rewards = [
  [
    "01",
    "Join in a minute",
    "Create your free Golden Rewards account in a few simple taps.",
  ],
  [
    "02",
    "Collect your crumbs",
    "Earn 10 crumbs for every dollar, in the bakery or online.",
  ],
  [
    "03",
    "Taste the rewards",
    "Turn crumbs into fresh pastries, coffee and birthday treats.",
  ],
];
...
function WheatMark() {
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" className="h-6 w-6">
      <path
        d="M16 29V8M16 13c-5-.3-8-3.1-8.5-7 5-.2 8.2 2.6 8.5 7Zm0 6c-5-.3-8-3.1-8.5-7 5-.2 8.2 2.6 8.5 7Zm0 6c-5-.3-8-3.1-8.5-7 5-.2 8.2 2.6 8.5 7Zm0-12c5-.3 8-3.1 8.5-7-5-.2-8.2 2.6-8.5 7Zm0 6c5-.3 8-3.1 8.5-7-5-.2-8.2 2.6-8.5 7Zm0 6c5-.3 8-3.1 8.5-7-5-.2-8.2 2.6-8.5 7Z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <main className="brand-motion motion-goldencrust overflow-hidden bg-[#fbf5e9] text-[#2d1a11]">
      ...
      >
        <img
          ...
          alt="Golden Crust Bakery counter filled with artisan bread and pastries"
        ...
        <Container className="flex min-h-[800px] items-end pb-16 pt-28 lg:min-h-[860px] lg:items-center lg:pb-12">
          <div className="max-w-3xl">
            <Link
              to="/restaurant"
              className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/15 bg-black/15 px-4 py-2 text-[0.65rem] font-black uppercase tracking-[0.14em] text-white/70 backdrop-blur transition hover:border-white/30 hover:text-white"
            >
            ...
            <p className="mt-7 max-w-xl text-base leading-8 text-white/65 sm:text-lg">
              ...
              good coffee—baked fresh every morning in the heart of Old Market.
            </p>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#rewards"
                className="inline-flex items-center justify-center rounded-full border border-white/25 bg-black/10 px-7 py-4 text-xs font-black uppercase tracking-[0.14em] backdrop-blur transition hover:-translate-y-1 hover:bg-white/10"
              >
                Join rewards
              </a>
            </div>
        ...
        <div className="absolute bottom-10 right-8 hidden w-64 rounded-[1.5rem] border border-white/15 bg-[#24140d]/80 p-5 shadow-2xl backdrop-blur-xl xl:block">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[0.58rem] font-black uppercase tracking-[0.18em] text-white/42">
                Fresh from the oven
              </p>
              <p className="mt-1 text-sm font-bold">Next batch · 10:30 AM</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <Container className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-20">
          <div className="relative pb-8 pr-0 sm:pr-10">
            <img
              ...
              alt="Warm Golden Crust artisan bakery interior"
              loading="lazy"
              className="aspect-[4/3] w-full rounded-[1.7rem] object-cover shadow-2xl shadow-[#482513]/15"
            />
            <img
      ...
      >
        ...
        <Container className="relative">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div>
              <Eyebrow light>Golden Rewards</Eyebrow>
              <h2 className="mt-5 text-4xl font-black leading-[0.93] tracking-[-0.05em] sm:text-6xl">
                A little thank-you in every bite.
              </h2>
            </div>
          ...
          >
            ...
            <div className="relative min-h-80 overflow-hidden">
              <img
                ...
                alt="Fresh pastry available as a Golden Rewards welcome gift"
                loading="lazy"
      ...
      >
        <img
          ...
          alt="Golden Crust pastries on the bakery counter"
          loading="lazy"
        ...
        <Container className="text-center">
          ...
          <h2 className="mx-auto mt-7 max-w-3xl text-4xl font-black leading-[0.94] tracking-[-0.05em] sm:text-6xl">
            There’s always something warm waiting.
          </h2>
          <p className="mx-auto mt-5 max-w-xl text-base leading-8 text-white/58">
            88 Brioche Lane · Old Market District
            <br />
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <a
              href="tel:5550142020"
              className="inline-flex items-center justify-center rounded-full border border-white/25 px-7 py-4 text-xs font-black uppercase tracking-[0.14em] transition hover:bg-white/10"
            >
              Call the bakery
            </a>
          </div>
